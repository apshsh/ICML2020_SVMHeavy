...
public:
    ...
    virtual Vector<gentype> &phi2(Vector<gentype> &res, int ia, const SparseVector<gentype> *xa = NULL, const vecInfo *xainf = NULL, int iaset = 0) const { return locgetSVMconst().phi2(res,ia,xa,xainf,iaset); }
    ...
    virtual Vector<double> &phi2(Vector<double> &res, int ia, const SparseVector<gentype> *xa = NULL, const vecInfo *xainf = NULL, int iaset = 0) const { return locgetSVMconst().phi2(res,ia,xa,xainf,iaset); }
...
//    virtual void dg(Vector<d_anion>         &res, d_anion        &resn, const gentype &y, const SparseVector<gentype> &x) const { return getQconst().dg(res,resn,y,x); }
    ...
    {
        return locgetSVMconst().detangle_x(xnear,xfar,xfarfar,xnearinfo,xfarinfo,inear,ifar,ineartup,ifartup,iokr,iok,i,idiagr,xx,xxinfo,gradOrder,iplanr,iplan,iset,usextang);
    }
