...
//FIXMEFIXME fnDim
                      ...
                      svmvolatile int &killSwitch)
    {
        ...
        if ( !ismoo )
        {
            ...
            {
//errstream() << "phantomx 0: sigma in altfnapprox = " << altfnapprox.sigma() << "\n";
                ML_Mutable *fnapproxRaw;
...
//errstream() << "phantomx 1: sigma in fnapprox = " << (*fnapprox).sigma() << "\n";
            }
...
//errstream() << "phantomxqq 24\n";
    ...
    int default_model_setsigma(double nv)  { return altfnapprox.setsigma(nv) | altfnapproxmoo.setsigma(nv); }
