...
public:
    ...
    awarestream(int _port, int _socktype = SVM_SOCK_STREAM, int _feedback = 0)
    {
        srcsel         = 2;
        str            = NULL;
        ostr           = NULL;
    ...
    awarestream(const std::string &_server_url, int _port, int _socktype = SVM_SOCK_STREAM, int _feedback = 0)
    {
        srcsel         = 2;
        str            = NULL;
        ostr           = NULL;
    ...
    awarestream(const char *dummy, std::string _addrpath, int _socktype = SVM_SOCK_STREAM, int _feedback = 0, int _sercli = 1)
    {
	(void) dummy;
