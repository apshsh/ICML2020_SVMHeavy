...
//         f for corresponding monotonic density kernel
//
// 800 use altcallback to evaluate kernel
...
//        |                        |
//   800  | altcallback kernel eval| Uses altcallback to evaluate kernel.  Assumed symmetric
//
// Notes: % non-mercer
...
public:
    ...
    int            isUnNormalised(int q = 0) const { return !isnorm(q);           }
    int            isChained     (int q = 0) const { return ischain(q);           }
    int            isUnChained   (int q = 0) const { return !ischain(q);          }
    int            isSplit       (int q = 0) const { return issplit(q);           }
    int            isUnSplit     (int q = 0) const { return !issplit(q);          }
    int            isMulSplit    (int q = 0) const { return mulsplit(q);          }
    int            isUnMulSplit  (int q = 0) const { return !mulsplit(q);         }
    int            isMagTerm     (int q = 0) const { return ismagterm(q);         }
    int            isUnMagTerm   (int q = 0) const { return !ismagterm(q);        }
    ...
    MercerKernel &setAltCall(int newMLid,       int q = 0) { xisfast = -1; xneedsInner = -1; xneedsDiff = -1; xneedsNorm = -1; altcallback("&",q) = newMLid; return *this; }
...
//    const SparseVector<gentype> &getx(const SparseVector<gentype> &x, int i) const { (void) i; return x; }
    ...
    inline double distK(const SparseVector<gentype> &x, const SparseVector<gentype> &y, const vecInfo &xinfo, const vecInfo &yinfo, int i = DEFAULT_VECT_INDEX, int j = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int mlid = 0, const Matrix<double> *xy = NULL, int iset = 0, int jset = 0, int assumreal = 0) const;
    inline void ddistKdx(double &xscaleres, double &yscaleres, int &minmaxind, const SparseVector<gentype> &x, const SparseVector<gentype> &y, const vecInfo &xinfo, const vecInfo &yinfo, int i = DEFAULT_VECT_INDEX, int j = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int mlid = 0, const Matrix<double> *xy = NULL, int iset = 0, int jset = 0, int assumreal = 0) const;
    ...
    gentype &Keqn(gentype &res, int resmode = 1) const
    {
        ...
        K2(res,x,y,xinfo,yinfo,defaultgentype(),NULL,DEFAULT_VECT_INDEX,DEFAULT_VECT_INDEX,0,0,resmode,0,NULL,0,0,0);
    ...
    inline gentype &K1(gentype &res, const SparseVector<gentype> &x, const vecInfo &xinfo, const gentype &bias, const gentype **pxyprod = NULL, int i = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int resmode = 0, int mlid = 0, const Matrix<double> *xy = NULL, int iset = 0, int assumreal = 0) const;
    inline double  &K1(double  &res, const SparseVector<gentype> &x, const vecInfo &xinfo, const double  &bias, const gentype **pxyprod = NULL, int i = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int resmode = 0, int mlid = 0, const Matrix<double> *xy = NULL, int iset = 0, int assumreal = 0) const;

    inline gentype &K2(gentype &res, const SparseVector<gentype> &x, const SparseVector<gentype> &y, const vecInfo &xinfo, const vecInfo &yinfo, const gentype &bias, const gentype **pxyprod = NULL, int i = DEFAULT_VECT_INDEX, int j = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int resmode = 0, int mlid = 0, const Matrix<double> *xy = NULL, int iset = 0, int jset = 0, int assumreal = 0) const;
    ...
    inline gentype &K4(gentype &res, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const SparseVector<gentype> &xd, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const vecInfo &xdinfo, const gentype &bias, const gentype **pxyprod = NULL, int i = DEFAULT_VECT_INDEX, int j = DEFAULT_VECT_INDEX, int k = DEFAULT_VECT_INDEX, int l = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int resmode = 0, int mlid = 0, const Matrix<double> *xy = NULL, const double *xy00 = NULL, const double *xy10 = NULL, const double *xy11 = NULL, const double *xy20 = NULL, const double *xy21 = NULL, const double *xy22 = NULL, const double *xy30 = NULL, const double *xy31 = NULL, const double *xy32 = NULL, const double *xy33 = NULL, int iaset = 0, int ibset = 0, int icset = 0, int idset = 0, int assumreal = 0) const;
    ...
    inline gentype &Km(int m, gentype &res, Vector<const SparseVector<gentype> *> &x, Vector<const vecInfo *> &xinfo, const gentype &bias, Vector<int> &i, const gentype **pxyprod = NULL, int xdim = 0, int xconsist = 0, int resmode = 0, int mlid = 0, const Matrix<double> *xy = NULL, const Vector<int> *iset = NULL, int assumreal = 0) const;
    inline double  &Km(int m, double  &res, Vector<const SparseVector<gentype> *> &x, Vector<const vecInfo *> &xinfo, const double  &bias, Vector<int> &i, const gentype **pxyprod = NULL, int xdim = 0, int xconsist = 0, int resmode = 0, int mlid = 0, const Matrix<double> *xy = NULL, const Vector<int> *iset = NULL, int assumreal = 0) const;

    // Feature maps
    //
    // phi2: returns the image of x in feature space.  This may be finite dimensional if possible 
    //       (and allowfinite = 1), but otherwise infinite dimensional.  Does not include bias term.
    // phi2dim: return -1 if feature map infinite dimensional, >= 0 otherwise

    Vector<gentype> &phi2(Vector<gentype> &res, const SparseVector<gentype> &x, int i = DEFAULT_VECT_INDEX, int allowfinite = 1, int xdim = 0, int xconsist = 0, int iset = 0, int assumreal = 0) const;
    Vector<double>  &phi2(Vector<double>  &res, const SparseVector<gentype> &x, int i = DEFAULT_VECT_INDEX, int allowfinite = 1, int xdim = 0, int xconsist = 0, int iset = 0, int assumreal = 0) const;
    int phi2dim(int allowfinite = 1, int xdim = 0) const;
    ...
    inline double &K2ip(double &res, const SparseVector<gentype> &x, const SparseVector<gentype> &y, const vecInfo &xinfo, const vecInfo &yinfo, const double &bias, const gentype **pxyprod = NULL, int i = DEFAULT_VECT_INDEX, int j = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int mlid = 0, int iset = 0, int jset = 0, int assumreal = 0) const;
    inline double &K4ip(double &res, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const SparseVector<gentype> &xd, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const vecInfo &xdinfo, const double &bias, const gentype **pxyprod = NULL, int i = DEFAULT_VECT_INDEX, int j = DEFAULT_VECT_INDEX, int k = DEFAULT_VECT_INDEX, int l = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int mlid = 0, int iaset = 0, int ibset = 0, int icset = 0, int idset = 0, int assumreal = 0) const;
    inline double &Kmip(int m, double &res, Vector<const SparseVector<gentype> *> &x, Vector<const vecInfo *> &xinfo, Vector<int> &i, const double &bias, const gentype **pxyprod = NULL, int xdim = 0, int xconsist = 0, int mlid = 0, const Vector<int> *iset = NULL, int assumreal = 0) const;
    ...
    inline void d2K2delxdelx(gentype &xxscaleres, gentype &yyscaleres, gentype &xyscaleres, gentype &yxscaleres, gentype &constres, int &minmaxind, const SparseVector<gentype> &x, const SparseVector<gentype> &y, const vecInfo &xinfo, const vecInfo &yinfo, const gentype &bias, const gentype **pxyprod = NULL, int i = DEFAULT_VECT_INDEX, int j = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int mlid = 0, const Matrix<double> *xy = NULL, int deepDerive = 0, int iset = 0, int jset = 0, int assumreal = 0) const;
    ...
    inline void dK(gentype &xygrad, gentype &xnormgrad, int &minmaxind, const SparseVector<gentype> &x, const SparseVector<gentype> &y, const vecInfo &xinfo, const vecInfo &yinfo, const gentype &bias, const gentype **pxyprod = NULL, int i = DEFAULT_VECT_INDEX, int j = DEFAULT_VECT_INDEX, int xdim = 0, int xconsist = 0, int mlid = 0, const Matrix<double> *xy = NULL, int deepDeriv = 0, int iset = 0, int jset = 0, int assumreal = 0) const;
...
private:
    ...
    // - first version goes through kernel structure and calls second version
    ...
    template <class T> T &xKKK1(T &res, const SparseVector<gentype> &xa, const vecInfo &xainfo, const T &bias, const gentype **pxyprod, int ia, int xdim, int xconsist, int assumreal, int resmode, int mlid, const Matrix<double> *xy, int justcalcip, int iaset) const;
    template <class T> T &xKKK2(T &res, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const vecInfo &xainfo, const vecInfo &xbinfo, const T &bias, const gentype **pxyprod, int ia, int ib, int xdim, int xconsist, int assumreal, int resmode, int mlid, const Matrix<double> *xy, int justcalcip, int iset, int jset) const;
    template <class T> T &xKKK3(T &res, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const T &bias, const gentype **pxyprod, int ia, int ib, int ic, int xdim, int xconsist, int assumreal, int xresmode, int mlid, const Matrix<double> *xy, int justcalcip, int iaset, int ibset, int icset) const;
    template <class T> T &xKKK4(T &res, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const SparseVector<gentype> &xd, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const vecInfo &xdinfo, const T &bias, const gentype **pxyprod, int ia, int ib, int ic, int id, int xdim, int xconsist, int assumreal, int xresmode, int mlid, const Matrix<double> *xy, int justcalcip, const double *xy00, const double *xy10, const double *xy11, const double *xy20, const double *xy21, const double *xy22, const double *xy30, const double *xy31, const double *xy32, const double *xy33, int iaset, int ibset, int icset, int idset) const;
    ...
    template <class T> void dKK2( T &xygrad, T &xnormgrad, int &minmaxind, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const vecInfo &xainfo, const vecInfo &xbinfo, const T &bias, const gentype **pxyprod, int ia, int ib, int xdim, int xconsist, int assumreal, int mlid, const Matrix<double> *xy, int deepDeriv, int iaset, int ibset, int skipbias = 0, int skipxa = 0, int skipxb = 0) const;
    ...
    template <class T> void dLL2( T &xygrad, T &xnormgrad, int &minmaxind, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const vecInfo &xainfo, const vecInfo &xbinfo, const T &bias, const gentype **pxyprod, int ia, int ib, int xdim, int xconsist, int assumreal, int mlid, const Matrix<double> *xy, int deepDeriv) const;
    template <class T> void d2LL2(T &xygrad, T &xnormgrad, T &xyxygrad, T &xyxnormgrad, T &xyynormgrad, T &xnormxnormgrad, T &xnormynormgrad, T &ynormynormgrad, int &minmaxind, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const vecInfo &xainfo, const vecInfo &xbinfo, const T &bias, const gentype **pxyprod, int ia, int ib, int xdim, int xconsist, int assumreal, int mlid, const Matrix<double> *xy, int deepDeriv) const;
...
//    template <class T> void dnKKprosingle(T &res, const Vector<int> &gd, const T &xyprod, const T &diffis, int i, int j, int locindstart, int locindend, int xdim, int m, int isfirstcalc, T &scratch, const T &xxprod, const T &yyprod, int ktype, const gentype &weight, const Vector<gentype> &r, const Vector<int> &ic, int magterm) const;
    ...
    void diff3norm(       gentype &res, const gentype &xyprod, const gentype &xanorm, const gentype &xbnorm, const gentype &xcnorm, const Matrix<double> &xy, const Vector<int> *s = NULL) const;
    void diff4norm(       gentype &res, const gentype &xyprod, const gentype &xanorm, const gentype &xbnorm, const gentype &xcnorm, const gentype &xdnorm, const Matrix<double> &xy, const Vector<int> *s = NULL) const;
    void diffmnorm(int m, gentype &res, const gentype &xyprod, const Vector<const gentype *> &xanorm, const Matrix<double> &xy, const Vector<int> *s = NULL) const;
    ...
    void diff3norm(       double &res, const double &xyprod, const double &xanorm, const double &xbnorm, const double &xcnorm, const Matrix<double> &xy, const Vector<int> *s = NULL) const;
    void diff4norm(       double &res, const double &xyprod, const double &xanorm, const double &xbnorm, const double &xcnorm, const double &xdnorm, const Matrix<double> &xy, const Vector<int> *s = NULL) const;
    void diffmnorm(int m, double &res, const double &xyprod, const Vector<const double *> &xanorm, const Matrix<double> &xy, const Vector<int> *s = NULL) const;
    ...
    void diff3norm(       gentype &res, const double &xyprod, const double &xanorm, const double &xbnorm, const double &xcnorm, const Matrix<double> &xy, const Vector<int> *s = NULL) const { diff3norm(res.force_double(),xyprod,xanorm,xbnorm,xcnorm,xy,s); return; }
    void diff4norm(       gentype &res, const double &xyprod, const double &xanorm, const double &xbnorm, const double &xcnorm, const double &xdnorm, const Matrix<double> &xy, const Vector<int> *s = NULL) const { diff4norm(res.force_double(),xyprod,xanorm,xbnorm,xcnorm,xdnorm,xy,s); return; }
    ...
    const Matrix<double> &fillXYMatrix(       Matrix<double> &altres, const SparseVector<gentype> &xa, const vecInfo &xainfo, const Matrix<double> *optionCache = NULL, int doanyhow = 0, int assumreal = 0) const;
    const Matrix<double> &fillXYMatrix(       Matrix<double> &altres, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const vecInfo &xainfo, const vecInfo &xbinfo, const Matrix<double> *optionCache = NULL, int doanyhow = 0, int assumreal = 0) const;
    const Matrix<double> &fillXYMatrix(       Matrix<double> &altres, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const Matrix<double> *optionCache = NULL, int doanyhow = 0, int assumreal = 0) const;
    const Matrix<double> &fillXYMatrix(       Matrix<double> &altres, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const SparseVector<gentype> &xd, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const vecInfo &xdinfo, const Matrix<double> *optionCache = NULL, int doanyhow = 0, int assumreal = 0) const;
...
//               ( ( kinf(0).numflagsset() == 0 ) || kinf(0).usesDiff || kinf(0).usesInner || kinf(0).usesMinDiff || kinf(0).usesMaxDiff );
    ...
    int isfastunsafe(void)
    {
        ...
        if ( xisfast == -1 )
        {
            ...
            if ( ( size() <= 1 ) || ( isnorm(zeroint(),1,size()-2,tmpva) == zeroint() ) )
            {
                ...
                else if ( !numSplits() && !numMulSplits() && (  ( size() >= 1 ) && ( ( isnorm(size()-1) == zeroint() ) || ( isAltDiff() <= 99 ) ) && ( ( ( size() == 1 ) || ( ( ischain(zeroint(),1,size()-2,tmpva) == 1 ) ) ) && ( cType(0) >= 800 ) && ( cType(0) < 899 ) ) ) )
                {
                    // Could be xisfast == 3
                    //          3  if completely chained kernel where kernel 0 is kernel transfer, kernel 1 is either inner-product or diff, and remaining kernels are inner-product (no splits or magterms allowed)
    ...
    // isSimpleXferKernel:       isSimpleKernel, and type 800-899 (kernel transfer)
...
public:
    ...
    int isSimpleXferKernel (void) const { return ( isSimpleKernel() && ( cType() >= 800 ) && ( cType() < 900 ) ); }
    int isSimpleKernelChain(void) const { return ( ( size() == 2 ) && ( cType() >= 800 ) && ( cType() <= 899 ) && !isNormalised(0) && !isNormalised(1) && isChained(0) && !isSplit(0) && !isMulSplit(0) && !isMagTerm() ); }
...
{
    return xKKK0(res,bias,pxyprod,xdim,xconsist,assumreal,xresmode,mlid,0);
}
...
double &MercerKernel::K1(double &res,
                         ...
                         const Matrix<double> *xy, int iset, int assumreal) const
{
    return xKKK1(res,x,xinfo,bias,pxyprod,i,xdim,xconsist,assumreal,resmode,mlid,xy,0,iset);
}
...
double &MercerKernel::K2(double &res,
                         ...
                         int i, int j,
                         int xdim, int xconsist, int resmode, int mlid, 
                         const Matrix<double> *xy, int iset, int jset, int assumreal) const
{
...
double &MercerKernel::K3(double &res,
                         ...
                         const Matrix<double> *xy, int iaset, int ibset, int icset, int assumreal) const
{
...
double &MercerKernel::K4(double &res,
                         ...
                         const double *xy00, const double *xy10, const double *xy11, const double *xy20, const double *xy21, const double *xy22, const double *xy30, const double *xy31, const double *xy32, const double *xy33, int iaset, int ibset, int icset, int idset, int assumreal) const
{
    return xKKK4(res,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,pxyprod,ia,ib,ic,id,xdim,xconsist,assumreal,xresmode,mlid,xy,0,xy00,xy10,xy11,xy20,xy21,xy22,xy30,xy31,xy32,xy33,iaset,ibset,icset,idset);
}
...
double &MercerKernel::Km(int m,
                         ...
                         const gentype **pxyprod,
                         int xdim, int xconsist, int resmode, int mlid, 
                         const Matrix<double> *xy, const Vector<int> *iset, int assumreal) const
{
...
gentype &MercerKernel::K1(gentype &res,
                          ...
                          const Matrix<double> *xy, int iset, int assumreal) const
{
    return xKKK1(res,x,xinfo,bias,pxyprod,i,xdim,xconsist,resmode,assumreal,mlid,xy,0,iset);
}
...
double MercerKernel::distK(const SparseVector<gentype> &x, const SparseVector<gentype> &y, 
                           const vecInfo &xinfo, const vecInfo &yinfo, 
                           int i, int j, 
                           int xdim, int xconsist, int mlid, const Matrix<double> *xy, int iset, int jset, int assumreal) const
{
    double res = 0;
    double temp = 0;
    ...
    {
        res += K2(temp,x,x,xinfo,xinfo,bias,NULL,i,i,xdim,xconsist,0,mlid,xy,iset,jset,assumreal);
        res += K2(temp,y,y,yinfo,yinfo,bias,NULL,j,j,xdim,xconsist,0,mlid,xy,iset,jset,assumreal);
    }

    res -= 2*K2(temp,x,y,xinfo,yinfo,bias,NULL,i,j,xdim,xconsist,0,mlid,xy,iset,jset,assumreal);
                            ...
                            int xdim, int xconsist, int mlid, const Matrix<double> *xy, int iset, int jset, int assumreal) const
{
    ...
    dK2delx(xres,yres,minmaxind,x,y,xinfo,yinfo,dummybias,NULL,i,j,xdim,xconsist,mlid,xy,iset,jset,assumreal);
    ...
    if ( !isSimpleDistKernel() )
    {
        dK2delx(xres,yres,minmaxind,x,x,xinfo,xinfo,dummybias,NULL,i,i,xdim,xconsist,mlid,xy,iset,jset,assumreal);

        xscaleres += (double) xres;
        xscaleres += (double) yres;

        dK2delx(xres,yres,minmaxind,y,y,yinfo,yinfo,dummybias,NULL,j,j,xdim,xconsist,mlid,xy,iset,jset,assumreal);
...
void MercerKernel::dK(double &xygrad, double &xnormgrad, int &minmaxind,
                        ...
                        const Matrix<double> *xy, int deepDeriv, int iset, int jset, int assumreal) const
{
    xdKK2(xygrad,xnormgrad,minmaxind,x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,assumreal,mlid,xy,deepDeriv,iset,jset);
                          ...
                          const Matrix<double> *xy, int iset, int jset, int assumreal) const
{
    ...
    dK(xygrad,xnormgrad,minmaxind,x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,mlid,xy,1,iset,jset,assumreal);
...
void MercerKernel::dnK2del(Vector<gentype> &sc, Vector<Vector<int> > &n, int &minmaxind, 
                          ...
                          int i, int j, 
                          int xdim, int xconsist, int mlid, 
                          const Matrix<double> *xy, int deepDerive, int iset, int jset, int assumreal) const
{
    int z = 0;
    ...
    if ( q.size() == 0 )
    {
        ...
        K2(sc("&",z),x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,0,mlid,xy,iset,jset,assumreal);
    }
    ...
    else if ( q.size() == 1 )
    {
        if ( q(z) == 0 )
        {
            ...
            dK2delx(sc("&",z),sc("&",1),minmaxind,x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,mlid,xy,iset,jset,assumreal);
        }
        ...
        else
        {
            ...
            dK2delx(sc("&",1),sc("&",z),minmaxind,y,x,yinfo,xinfo,bias,NULL,j,i,xdim,xconsist,mlid,NULL,0,0,assumreal);
        }
    }
    ...
    else if ( q.size() == 2 )
    {
        if ( ( q(z) == 0 ) && ( q(1) == 0 ) )
        {
            ...
            d2K2delxdelx(sc("&",z),sc("&",1),sc("&",2),sc("&",3),sc("&",4),minmaxind,x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,mlid,xy,deepDerive,iset,jset,assumreal);
        }
        ...
        else if ( ( q(z) == 0 ) && ( q(1) == 1 ) )
        {
            ...
            d2K2delxdely(sc("&",z),sc("&",1),sc("&",2),sc("&",3),sc("&",4),minmaxind,x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,mlid,xy,deepDerive,iset,jset,assumreal);
        }
        ...
        else if ( ( q(z) == 1 ) && ( q(1) == 0 ) )
        {
            ...
            d2K2delxdely(sc("&",1),sc("&",z),sc("&",3),sc("&",2),sc("&",4),minmaxind,y,x,yinfo,xinfo,bias,NULL,j,i,xdim,xconsist,mlid,NULL,deepDerive,iset,jset,assumreal);
        }
        ...
        else
        {
            ...
            d2K2delxdelx(sc("&",1),sc("&",z),sc("&",3),sc("&",2),sc("&",4),minmaxind,y,x,yinfo,xinfo,bias,NULL,j,i,xdim,xconsist,mlid,NULL,deepDerive,iset,jset,assumreal);
        }
    }

    else
    {
        xdnKK2del(sc,n,minmaxind,q,x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,assumreal,mlid,xy,deepDerive,iset,jset);
    }
                          ...
                          const Matrix<double> *xy, int deepDerive, int iset, int jset, int assumreal) const
{
    ...
    else if ( q.size() == 1 )
    {
        ...
        else
        {
            ...
            dK2delx(sc("&",1),sc("&",z),minmaxind,y,x,yinfo,xinfo,bias,NULL,j,i,xdim,xconsist,mlid,NULL,iset,jset,assumreal);
        }
    }
                 ...
                 const Matrix<double> *xy, int deepDeriv, int iset, int jset, int assumreal) const
{
    ...
    d2K(xygrad,xnormgrad,xyxygrad,xyxnormgrad,xyynormgrad,xnormxnormgrad,xnormynormgrad,ynormynormgrad,minmaxind,x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,mlid,xy,deepDeriv,iset,jset,assumreal);
...
void MercerKernel::d2K(gentype &xygrad, gentype &xnormgrad, gentype &xyxygrad, gentype &xyxnormgrad, gentype &xyynormgrad, gentype &xnormxnormgrad, gentype &xnormynormgrad, gentype &ynormynormgrad, int &minmaxind, 
         ...
         const Matrix<double> *xy, int deepDeriv, int iset, int jset, int assumreal) const
{
    xd2KK2(xygrad,xnormgrad,xyxygrad,xyxnormgrad,xyynormgrad,xnormxnormgrad,xnormynormgrad,ynormynormgrad,minmaxind,x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,assumreal,mlid,xy,deepDeriv,iset,jset);
...
{
    return xKKK0(res,bias,pxyprod,xdim,xconsist,assumreal,0,mlid,1);
}
...
double &MercerKernel::K2ip(double &res,
                        ...
                        const double &bias, const gentype **pxyprod,
                        int i, int j,
                        int xdim, int xconsist, int mlid, int iset, int jset, int assumreal) const
{
    return xKKK2(res,x,y,xinfo,yinfo,bias,pxyprod,i,j,xdim,xconsist,assumreal,0,mlid,NULL,1,iset,jset);
}
...
double &MercerKernel::K4ip(double &res,
                         ...
                         const double &bias, const gentype **pxyprod,
                         int ia, int ib, int ic, int id,
                         int xdim, int xconsist, int mlid, int iaset, int ibset, int icset, int idset, int assumreal) const
{
    return xKKK4(res,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,pxyprod,ia,ib,ic,id,xdim,xconsist,assumreal,0,mlid,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,iaset,ibset,icset,idset);
}
...
double &MercerKernel::Kmip(int m,
                         ...
                         Vector<int> &i,
                         const double &bias, const gentype **pxyprod,
                         int xdim, int xconsist, int mlid, const Vector<int> *iset, int assumreal) const
{
    return xKKKm(m,res,x,xinfo,bias,i,pxyprod,xdim,xconsist,assumreal,0,mlid,NULL,1,iset);
}
...
template <class T> T &MercerKernel::xKKK1(T &res, const SparseVector<gentype> &xa, const vecInfo &xainfo, const T &bias, const gentype **pxyprod, int ia, int xdim, int xconsist, int assumreal, int resmode, int mlid, const Matrix<double> *xy, int justcalcip, int iaset) const
{
    if ( numMulSplits() )
    {
        int q,r = 0;
...
template <class T> T &MercerKernel::xKKK2(T &res, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const vecInfo &xainfo, const vecInfo &xbinfo, const T &bias, const gentype **pxyprod, int ia, int ib, int xdim, int xconsist, int assumreal, int resmode, int mlid, const Matrix<double> *xy, int justcalcip, int iset, int jset) const
{
    if ( numMulSplits() )
    {
        int q,r = 0;
        ...
        for ( q = 0 ; q <= numMulSplits() ; q++ )
        {
            ...
            if ( !q )
            {
                xKK2(res,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,resmode,mlid,xy,justcalcip,iset,jset,indstart,indend,calcnumSplits(indstart,indend));
            }
            ...
            else
            {
                ...
                xKK2(tempres,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,resmode,mlid,xy,justcalcip,iset,jset,indstart,indend,calcnumSplits(indstart,indend));
    ...
    {
        xKK2(res,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,resmode,mlid,xy,justcalcip,iset,jset,0,size()-1,numSplits());
    }

    return res;
}

template <class T> T &MercerKernel::xKKK3(T &res, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const T &bias, const gentype **pxyprod, int ia, int ib, int ic, int xdim, int xconsist, int assumreal, int xresmode, int mlid, const Matrix<double> *xy, int justcalcip, int iaset, int ibset, int icset) const
{
    if ( numMulSplits() )
    {
        int q,r = 0;
        ...
        for ( q = 0 ; q <= numMulSplits() ; q++ )
        {
            ...
            if ( !q )
            {
                xKK3(res,xa,xb,xc,xainfo,xbinfo,xcinfo,bias,pxyprod,ia,ib,ic,xdim,xconsist,assumreal,xresmode,mlid,xy,justcalcip,iaset,ibset,icset,indstart,indend,calcnumSplits(indstart,indend));
            }
            ...
            else
            {
                ...
                xKK3(tempres,xa,xb,xc,xainfo,xbinfo,xcinfo,bias,pxyprod,ia,ib,ic,xdim,xconsist,assumreal,xresmode,mlid,xy,justcalcip,iaset,ibset,icset,indstart,indend,calcnumSplits(indstart,indend));
    ...
    {
        xKK3(res,xa,xb,xc,xainfo,xbinfo,xcinfo,bias,pxyprod,ia,ib,ic,xdim,xconsist,assumreal,xresmode,mlid,xy,justcalcip,iaset,ibset,icset,0,size()-1,numSplits());
    }

    return res;
}

template <class T> T &MercerKernel::xKKK4(T &res, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const SparseVector<gentype> &xd, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const vecInfo &xdinfo, const T &bias, const gentype **pxyprod, int ia, int ib, int ic, int id, int xdim, int xconsist, int assumreal, int xresmode, int mlid, const Matrix<double> *xy, int justcalcip, const double *xy00, const double *xy10, const double *xy11, const double *xy20, const double *xy21, const double *xy22, const double *xy30, const double *xy31, const double *xy32, const double *xy33, int iaset, int ibset, int icset, int idset) const
{
    if ( numMulSplits() )
    {
        int q,r = 0;
        ...
        for ( q = 0 ; q <= numMulSplits() ; q++ )
        {
            ...
            if ( !q )
            {
                xKK4(res,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,pxyprod,ia,ib,ic,id,xdim,xconsist,assumreal,xresmode,mlid,xy,justcalcip,xy00,xy10,xy11,xy20,xy21,xy22,xy30,xy31,xy32,xy33,iaset,ibset,icset,idset,indstart,indend,calcnumSplits(indstart,indend));
            }
            ...
            else
            {
                ...
                xKK4(tempres,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,pxyprod,ia,ib,ic,id,xdim,xconsist,assumreal,xresmode,mlid,xy,justcalcip,xy00,xy10,xy11,xy20,xy21,xy22,xy30,xy31,xy32,xy33,iaset,ibset,icset,idset,indstart,indend,calcnumSplits(indstart,indend));
    ...
    {
        xKK4(res,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,pxyprod,ia,ib,ic,id,xdim,xconsist,assumreal,xresmode,mlid,xy,justcalcip,xy00,xy10,xy11,xy20,xy21,xy22,xy30,xy31,xy32,xy33,iaset,ibset,icset,idset,0,size()-1,numSplits());
    }
...
T &MercerKernel::xKK1(T &res,
                     ...
                     const Matrix<double> *xy, int justcalcip, int iset, int indstart, int indend, int ns) const
{
    T logres; logres = 0.0;
    int logresvalid = 0;
    //int ns = numSplits();
...
T &MercerKernel::xKK2(T &res,
                     ...
                     int ia, int ib,
                     int xdim, int xconsist, int assumreal, int resmode, int mlid, 
                     const Matrix<double> *xy, int justcalcip, int iset, int jset, int indstart, int indend, int ns) const
{
    T logres; logres = 0.0;
    int logresvalid = 0;
    //int ns = numSplits();
    ...
    if ( isfullnorm && !ns && !justcalcip )
    {
        ...
        if ( xainfo.xusize() == 1 )
        {
            ...
            KK2(res,logres,logresvalid,xa,xb,xainfo,xbinfo,bias,NULL,ia,ib,xdim,xconsist,assumreal,resmode,mlid,xy,justcalcip,indstart,indend,iset,jset);

            KK2(tma,logtma,logtmavalid,xa,xa,xainfo,xainfo,bias,NULL,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend,iset,iset);
            KK2(tmb,logtmb,logtmbvalid,xb,xb,xbinfo,xbinfo,bias,NULL,ib,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend,jset,jset);
    ...
    else if ( !isfullnorm && ns && !justcalcip )
    {
        ...
        if ( xainfo.xusize() == 1 )
        {
            KK2(res,logres,logresvalid,xa,xb,xainfo,xbinfo,bias,NULL,ia,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iset,jset);
        }
...
//            indendb   = splitPoint(1);
        ...
        if ( xainfo.xusize() == 1 )
        {
            ...
            KK2(tma,logtma,logtmavalid,xa,xa,xainfo,xainfo,bias,NULL,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iset,iset);
            KK2(tmb,logtmb,logtmbvalid,xb,xb,xbinfo,xbinfo,bias,NULL,ib,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,jset,jset);
    ...
    {
        KK2(res,logres,logresvalid,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,resmode,mlid,xy,justcalcip,indstart,indend,iset,jset);
    }
...
T &MercerKernel::xKK3(T &res,
                     ...
                     int ia, int ib, int ic, 
                     int xdim, int xconsist, int assumreal, int resmode, int mlid, 
                     const Matrix<double> *xy, int justcalcip, int iaset, int ibset, int icset, int indstart, int indend, int ns) const
{
    T logres; logres = 0.0;
    T tempres; tempres = 0.0;
    ...
    if ( isfullnorm && !ns && !justcalcip )
    {
        ...
        if ( ( xainfo.xusize() == 1 ) && ( xbinfo.xusize() == 1 ) )
        {
            ...
            KK3(res,logres,logresvalid,xa,xb,xc,xainfo,xbinfo,xcinfo,bias,NULL,ia,ib,ic,xdim,xconsist,assumreal,resmode,mlid,xy,NULL,justcalcip,indstart,indend,iaset,ibset,icset);

            KK3(tma,logtma,logtmavalid,xa,xa,xa,xainfo,xainfo,xainfo,bias,NULL,ia,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstart,indend,iaset,iaset,iaset);
            KK3(tmb,logtmb,logtmbvalid,xb,xb,xb,xbinfo,xbinfo,xbinfo,bias,NULL,ib,ib,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstart,indend,ibset,ibset,ibset);
            KK3(tmc,logtmc,logtmcvalid,xc,xc,xc,xcinfo,xcinfo,xcinfo,bias,NULL,ic,ic,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstart,indend,icset,icset,icset);
        ...
        else if ( xainfo.xusize() == 2 )
        {
            ...
            KK4(tma,logtma,logtmavalid,xa,xb,xa,xb,xainfo,xbinfo,xainfo,xbinfo,bias,NULL,ia,ib,ia,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend,iaset,ibset,iaset,ibset);
            KK2(tmb,logtmb,logtmbvalid,xc,xc,xcinfo,xcinfo,bias,NULL,ic,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend,icset,icset);
        ...
        else if ( xbinfo.xusize() == 2 )
        {
            ...
            KK2(tma,logtma,logtmavalid,xa,xa,xainfo,xainfo,bias,NULL,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend,iaset,iaset);
            KK4(tmb,logtmb,logtmbvalid,xb,xc,xb,xc,xbinfo,xcinfo,xbinfo,xcinfo,bias,NULL,ib,ic,ib,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend,ibset,icset,ibset,icset);
    ...
    else if ( !isfullnorm && ns && !justcalcip )
    {
        ...
        if ( ( xainfo.xusize() == 1 ) && ( xbinfo.xusize() == 1 ) )
        {
            KK3(res,logres,logresvalid,xa,xb,xc,xainfo,xbinfo,xcinfo,bias,NULL,ia,ib,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstarta,indenda,iaset,ibset,icset);
        }

        else if ( xainfo.xusize() == 2 )
        {
            KK2(    res,logres,logresvalid,xa,xc,xainfo,xcinfo,bias,NULL,ia,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iaset,icset);
        ...
        {
            KK2(    res,logres,logresvalid,xa,xb,xainfo,xbinfo,bias,NULL,ia,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iaset,ibset);
...
//            indendc   = splitPoint(2);
        ...
        if ( ( xainfo.xusize() == 1 ) && ( xbinfo.xusize() == 1 ) )
        {
            ...
            KK3(tma,logtma,logtmavalid,xa,xa,xa,xainfo,xainfo,xainfo,bias,NULL,ia,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstarta,indenda,iaset,iaset,iaset);
            KK3(tmb,logtmb,logtmbvalid,xb,xb,xb,xbinfo,xbinfo,xbinfo,bias,NULL,ib,ib,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstarta,indenda,ibset,ibset,ibset);
            KK3(tmc,logtmc,logtmcvalid,xc,xc,xc,xcinfo,xcinfo,xcinfo,bias,NULL,ic,ic,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstarta,indenda,icset,icset,icset);
        ...
        else if ( xainfo.xusize() == 2 )
        {
            ...
            KK2(tma,logtma,logtmavalid,xa,xa,xainfo,xainfo,bias,NULL,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iaset,iaset);
            KK2(tmb,logtmb,logtmbvalid,xc,xc,xcinfo,xcinfo,bias,NULL,ic,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,icset,icset);
        ...
        else if ( xbinfo.xusize() == 2 )
        {
            ...
            KK2(tma,logtma,logtmavalid,xa,xa,xainfo,xainfo,bias,NULL,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iaset,iaset);
            KK2(tmb,logtmb,logtmbvalid,xb,xb,xbinfo,xbinfo,bias,NULL,ib,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,ibset,ibset);
    ...
    {
        KK3(res,logres,logresvalid,xa,xb,xc,xainfo,xbinfo,xcinfo,bias,pxyprod,ia,ib,ic,xdim,xconsist,assumreal,resmode,mlid,xy,NULL,justcalcip,indstart,indend,iaset,ibset,icset);
    }
...
T &MercerKernel::xKK4(T &res,
                     ...
                     const gentype **pxyprod,
                     int ia, int ib, int ic, int id, 
                     int xdim, int xconsist, int assumreal, int resmode, int mlid, const Matrix<double> *xy, int justcalcip, 
                     const double *xy00, const double *xy10, const double *xy11, const double *xy20, const double *xy21, const double *xy22, const double *xy30, const double *xy31, const double *xy32, const double *xy33, int iaset, int ibset, int icset, int idset, int indstart, int indend, int ns) const
{
    ...
    if ( isfullnorm && !ns && !justcalcip )
    {
        ...
        if ( ( xainfo.xusize() == 1 ) && ( xbinfo.xusize() == 1 ) && ( xcinfo.xusize() == 1 ) )
        {
            ...
            KK4(res,logres,logresvalid,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,NULL,justcalcip,xy00,xy10,xy11,xy20,xy21,xy22,xy30,xy31,xy32,xy33,indstart,indend,iaset,ibset,icset,idset);

            KK4(tma,logtma,logtmavalid,xa,xa,xa,xa,xainfo,xainfo,xainfo,xainfo,bias,NULL,ia,ia,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,xy00,xy00,xy00,xy00,xy00,xy00,xy00,xy00,xy00,xy00,indstart,indend,iaset,iaset,iaset,iaset);
            KK4(tmb,logtmb,logtmbvalid,xb,xb,xb,xb,xbinfo,xbinfo,xbinfo,xbinfo,bias,NULL,ib,ib,ib,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,xy11,xy11,xy11,xy11,xy11,xy11,xy11,xy11,xy11,xy11,indstart,indend,ibset,ibset,ibset,ibset);
            KK4(tmc,logtmc,logtmcvalid,xc,xc,xc,xc,xcinfo,xcinfo,xcinfo,xcinfo,bias,NULL,ic,ic,ic,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,xy22,xy22,xy22,xy22,xy22,xy22,xy22,xy22,xy22,xy22,indstart,indend,icset,icset,icset,icset);
            KK4(tmd,logtmd,logtmdvalid,xd,xd,xd,xd,xdinfo,xdinfo,xdinfo,xdinfo,bias,NULL,id,id,id,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,xy33,xy33,xy33,xy33,xy33,xy33,xy33,xy33,xy33,xy33,indstart,indend,idset,idset,idset,idset);
        ...
        else if ( ( xainfo.xusize() == 2 ) && ( xcinfo.xusize() == 1 ) )
        {
            ...
            KK3(tmb,logtmb,logtmbvalid,xc,xc,xc,xcinfo,xcinfo,xcinfo,bias,NULL,ic,ic,ic,xdim,xconsist,assumreal,mlid,resmode,NULL,NULL,justcalcip,indstart,indend,icset,icset,icset);
            KK3(tmc,logtmc,logtmcvalid,xd,xd,xd,xdinfo,xdinfo,xdinfo,bias,NULL,id,id,id,xdim,xconsist,assumreal,mlid,resmode,NULL,NULL,justcalcip,indstart,indend,idset,idset,idset);
        ...
        else if ( ( xainfo.xusize() == 1 ) && ( xbinfo.xusize() == 2 ) )
        {
            ...
            KK3(tmc,logtmc,logtmcvalid,xd,xd,xd,xdinfo,xdinfo,xdinfo,bias,NULL,id,id,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstart,indend,idset,idset,idset);
        ...
        else if ( ( xainfo.xusize() == 2 ) && ( xcinfo.xusize() == 2 ) )
        {
            ...
            KK4(tma,logtma,logtmavalid,xa,xb,xa,xb,xainfo,xbinfo,xainfo,xbinfo,bias,NULL,ia,ib,ia,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,xy00,xy10,xy11,xy00,xy10,xy00,xy10,xy11,xy10,xy11,indstart,indend,iaset,ibset,iaset,ibset);
            KK4(tmb,logtmb,logtmbvalid,xc,xd,xc,xd,xcinfo,xdinfo,xcinfo,xdinfo,bias,NULL,ic,id,ic,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,xy22,xy32,xy33,xy22,xy32,xy22,xy32,xy33,xy32,xy33,indstart,indend,icset,idset,icset,idset);
        ...
        else if ( xainfo.xusize() == 3 )
        {
            ...
            KK2(tmb,logtmb,logtmbvalid,xd,xd,xdinfo,xdinfo,bias,NULL,id,id,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend,idset,idset);
        ...
        else if ( xbinfo.xusize() == 3 )
        {
            ...
            KK2(tmb,logtma,logtmavalid,xa,xa,xainfo,xainfo,bias,NULL,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend,iaset,iaset);
    ...
    else if ( !isfullnorm && ns && !justcalcip )
    {
        ...
        if ( ( xainfo.xusize() == 1 ) && ( xbinfo.xusize() == 1 ) && ( xcinfo.xusize() == 1 ) )
        {
            KK4(res,logres,logresvalid,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstarta,indenda,iaset,ibset,icset,idset);
        }

        else if ( ( xainfo.xusize() == 2 ) && ( xcinfo.xusize() == 1 ) )
        {
            KK3(     res,logres,logresvalid,xa,xc,xd,xainfo,xcinfo,xdinfo,bias,NULL,ia,ic,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstarta,indenda,iaset,icset,idset);
        ...
        {
            KK3(     res,logres,logresvalid,xa,xb,xd,xainfo,xbinfo,xdinfo,bias,NULL,ia,ib,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstarta,indenda,iaset,ibset,idset);
        ...
        {
            KK2(     res,logres,logresvalid,xa,xc,xainfo,xcinfo,bias,NULL,ia,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iaset,icset);
            KK2(atempres,logres,logresvalid,xb,xd,xbinfo,xdinfo,bias,NULL,ib,id,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstartb,indendb,ibset,idset);
        ...
        {
            KK2(     res,logres,logresvalid,xa,xd,xainfo,xdinfo,bias,NULL,ia,id,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iaset,idset);
            KK1(atempres,logres,logresvalid,xb,xbinfo,bias,NULL,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstartb,indendb,ibset);
...
//            indendd   = splitPoint(3);
        ...
        if ( ( xainfo.xusize() == 1 ) && ( xbinfo.xusize() == 1 ) && ( xcinfo.xusize() == 1 ) )
        {
            ...
            KK4(tma,logtma,logtmavalid,xa,xa,xa,xa,xainfo,xainfo,xainfo,xainfo,bias,NULL,ia,ia,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstarta,indenda,iaset,iaset,iaset,iaset);
            KK4(tmb,logtmb,logtmbvalid,xb,xb,xb,xb,xbinfo,xbinfo,xbinfo,xbinfo,bias,NULL,ib,ib,ib,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstarta,indenda,ibset,ibset,ibset,ibset);
            KK4(tmc,logtmc,logtmcvalid,xc,xc,xc,xc,xcinfo,xcinfo,xcinfo,xcinfo,bias,NULL,ic,ic,ic,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstarta,indenda,icset,icset,icset,icset);
            KK4(tmd,logtmd,logtmdvalid,xd,xd,xd,xd,xdinfo,xdinfo,xdinfo,xdinfo,bias,NULL,id,id,id,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstarta,indenda,idset,idset,idset,idset);
        ...
        else if ( ( xainfo.xusize() == 2 ) && ( xcinfo.xusize() == 1 ) )
        {
            ...
            KK3(tma,logtma,logtmavalid,xa,xa,xa,xainfo,xainfo,xainfo,bias,NULL,ia,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstarta,indenda,iaset,iaset,iaset);
            KK3(tmb,logtmb,logtmbvalid,xc,xc,xc,xcinfo,xcinfo,xcinfo,bias,NULL,ic,ic,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstarta,indenda,icset,icset,icset);
            KK3(tmc,logtmc,logtmcvalid,xd,xd,xd,xdinfo,xdinfo,xdinfo,bias,NULL,id,id,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstarta,indenda,idset,idset,idset);
        ...
        else if ( ( xainfo.xusize() == 2 ) && ( xcinfo.xusize() == 2 ) )
        {
            ...
            KK2(tma,logtma,logtmavalid,xa,xa,xainfo,xainfo,bias,NULL,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iaset,iaset);
            KK2(tmc,logtmc,logtmcvalid,xc,xc,xcinfo,xcinfo,bias,NULL,ic,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,ibset,ibset);
            KK2(tmb,logtmb,logtmbvalid,xb,xb,xbinfo,xbinfo,bias,NULL,ib,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstartb,indendb,icset,icset);
            KK2(tmd,logtmd,logtmdvalid,xd,xd,xdinfo,xdinfo,bias,NULL,id,id,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstartb,indendb,idset,idset);
        ...
        else if ( xainfo.xusize() == 3 )
        {
            ...
            KK2(tma,logtma,logtmavalid,xa,xa,xainfo,xainfo,bias,NULL,ia,ia,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,iaset,iaset);
            KK2(tmb,logtmb,logtmbvalid,xd,xd,xdinfo,xdinfo,bias,NULL,id,id,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstarta,indenda,idset,idset);
    ...
    {
        KK4(res,logres,logresvalid,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,pxyprod,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,NULL,justcalcip,xy00,xy10,xy11,xy20,xy21,xy22,xy30,xy31,xy32,xy33,indstart,indend,iaset,ibset,icset,idset);
    }
...
T &MercerKernel::KK1(T &res, T &logres, int &logresvalid,
                     ...
                     int ia,  
                     int xdim, int xconsist, int assumreal, int resmode, int mlid,
                     const Matrix<double> *xy, int justcalcip, int indstart, int indend, 
                     int iaset, 
                     int skipbias, 
                     int skipxa) const
{
                     ...
                     int skipxa, int skipxb) const
{
    if ( !skipbias && isiteqn(bias) )
    {
        ...
        for ( qb = 0 ; qb < maxq ; qb++ )
        {
            ...
            KK2(gres,glogres,logresvalid,xa,xb,xainfo,xbinfo,gbias,NULL,ia,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend,iaset,ibset,1,skipxa,skipxb);
...
postbias:
    ...
    if ( !skipxa && xainfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK2(gres,glogres,logresvalid,xxa,xb,xxainfo,xbinfo,gbias,NULL,ia,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend,iaset,ibset,skipbias,1,skipxb);
...
postxa:
    ...
    if ( !skipxb && xbinfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK2(gres,glogres,logresvalid,xa,xxb,xainfo,xxbinfo,gbias,NULL,ia,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend,iaset,ibset,skipbias,skipxa,1);
...
postxb:
    ...
    LL2(res,logres,logresvalid,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,resmode,mlid,xy,justcalcip,indstart,indend);
                     ...
                     int skipxa, int skipxb, int skipxc) const
{
    if ( !skipbias && isiteqn(bias) )
    {
        ...
        for ( qb = 0 ; qb < maxq ; qb++ )
        {
            ...
            KK3(gres,glogres,logresvalid,xa,xb,xc,xainfo,xbinfo,xcinfo,gbias,NULL,ia,ib,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstart,indend,iaset,ibset,icset,1,skipxa,skipxb,skipxc);
...
postbias:
    ...
    if ( !skipxa && xainfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK3(gres,glogres,logresvalid,xxa,xb,xc,xxainfo,xbinfo,xcinfo,gbias,NULL,ia,ib,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstart,indend,iaset,ibset,icset,skipbias,1,skipxb,skipxc);
...
postxa:
    ...
    if ( !skipxb && xbinfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK3(gres,glogres,logresvalid,xa,xxb,xc,xainfo,xxbinfo,xcinfo,gbias,NULL,ia,ib,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstart,indend,iaset,ibset,icset,skipbias,skipxa,1,skipxc);
...
postxb:
    ...
    if ( !skipxc && xcinfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK3(gres,glogres,logresvalid,xa,xb,xxc,xainfo,xbinfo,xxcinfo,gbias,NULL,ia,ib,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,indstart,indend,iaset,ibset,icset,skipbias,skipxa,skipxb,1);
...
postxc:
    ...
    LL3(res,logres,logresvalid,xa,xb,xc,xainfo,xbinfo,xcinfo,bias,pxyprod,ia,ib,ic,xdim,xconsist,assumreal,resmode,mlid,xy,s,justcalcip,indstart,indend);
...
T &MercerKernel::KK4(T &res, T &logres, int &logresvalid,
                     ...
                     int ia, int ib, int ic, int id, 
                     int xdim, int xconsist, int assumreal, int resmode, int mlid,
                     const Matrix<double> *xy, const Vector<int> *s, int justcalcip,
                     ...
                     int skipxa, int skipxb, int skipxc, int skipxd) const
{
    if ( !skipbias && isiteqn(bias) )
    {
        ...
        for ( qb = 0 ; qb < maxq ; qb++ )
        {
            ...
            KK4(gres,glogres,logresvalid,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,gbias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend,iaset,ibset,icset,idset,1,skipxa,skipxb,skipxc,skipxd);
...
postbias:
    ...
    if ( !skipxa && xainfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK4(gres,glogres,logresvalid,xxa,xb,xc,xd,xxainfo,xbinfo,xcinfo,xdinfo,gbias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend,iaset,ibset,icset,idset,skipbias,1,skipxb,skipxc,skipxd);
...
postxa:
    ...
    if ( !skipxb && xbinfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK4(gres,glogres,logresvalid,xa,xxb,xc,xd,xainfo,xxbinfo,xcinfo,xdinfo,gbias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend,iaset,ibset,icset,idset,skipbias,skipxa,1,skipxc,skipxd);
...
postxb:
    ...
    if ( !skipxc && xcinfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK4(gres,glogres,logresvalid,xa,xb,xxc,xd,xainfo,xbinfo,xxcinfo,xdinfo,gbias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend,iaset,ibset,icset,idset,skipbias,skipxa,skipxb,1,skipxd);
...
postxc:
    ...
    if ( !skipxd && xdinfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK4(gres,glogres,logresvalid,xa,xb,xc,xxd,xainfo,xbinfo,xcinfo,xxdinfo,gbias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,NULL,NULL,justcalcip,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend,iaset,ibset,icset,idset,skipbias,skipxa,skipxb,skipxc,1);
...
postxd:
    ...
    LL4(res,logres,logresvalid,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,pxyprod,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,s,justcalcip,xy00,xy10,xy11,xy20,xy21,xy22,xy30,xy31,xy32,xy33,indstart,indend);
                     ...
                     int xdim, int xconsist, int assumreal, int resmode, int mlid, int justcalcip, int indstart, int indend) const
{
    ...
    else if ( isprod )
    {
        ...
        static Matrix<double> xy;

        LLm(0,res,logres,logresvalid,xx,xxinfo,bias,ii,pxyprod,xdim,xconsist,assumreal,resmode,mlid,&xy,NULL,0,indstart,indend);
    }
...
T &MercerKernel::LL1(T &res, T &logres, int &logresvalid,
                     ...
                     const gentype **pxyprod,
                     int ia,  
                     int xdim, int xconsist, int assumreal, int resmode, int mlid, const Matrix<double> *xy, int justcalcip, int indstart, int indend) const
{
    NiceAssert( ! ( isFastKernelSum() && ( isAltDiff() >= 200 ) && ( isAltDiff() <= 299 ) ) );
    ...
    else if ( isprod )
    {
        ...
        LLm(1,res,logres,logresvalid,xx,xxinfo,bias,ii,pxyprod,xdim,xconsist,assumreal,resmode,mlid,xy,NULL,0,indstart,indend);
    }
                     ...
                     int xdim, int xconsist, int assumreal, int resmode, int mlid, const Matrix<double> *xy, int justcalcip, int indstart, int indend) const
{
    ...
    if ( ( resmode & 0x01 ) )
    {
        ...
        K2i(dummyres,defaultgentype(),defaultgentype(),xinfo,yinfo,getmnorm(xinfo,x,2,xconsist,assumreal),getmnorm(yinfo,y,2,xconsist,assumreal),x,y,i,j,xdim,0,resmode,mlid,indstart,indend,assumreal); //,xy);
        ...
        if ( xconsist && ( size() == 1 ) && isSimpleKernel() )
        {
            ...
            if ( x.nearindsize() )
            {
                for ( ii = 0 ; ii < x.nearindsize() ; ii++ )
                {
                    ...
                    LL2(tempres,dummya,dummyb,xx,yy,xxinfo,yyinfo,bias,NULL,i,j,1,1,assumreal,0,mlid,NULL,0,indstart,indend);
    ...
    else if ( isFastKernelSum() || isFastKernelChain() || ( isFastKernelXfer() && !resmode ) || justcalcip )
    {
        ...
        if ( isFastKernelSum() || isFastKernelChain() || justcalcip )
        {
            if ( xy && ( (*xy).numRows() >= 2 ) && ( (*xy).numCols() >= 2 ) && !justcalcip )
            {
                xyprod = (*xy)(zeroint(),1);
                yxprod = (*xy)(1,zeroint());
            ...
            if ( needxxprod && !justcalcip )
            {
                if ( xy && ( (*xy).numRows() >= 2 ) && ( (*xy).numCols() >= 2 ) )
                {
                    xxprod = (*xy)(zeroint(),zeroint());
                    yyprod = (*xy)(1,1);
                     ...
                     const Matrix<double> *xy, const Vector<int> *s, int justcalcip, int indstart, int indend) const
{
    ...
    else if ( isprod && !arexysimple(xa,xb,xc) )
    {
        ...
        LLm(3,res,logres,logresvalid,xx,xxinfo,bias,ii,pxyprod,xdim,xconsist,assumreal,resmode,mlid,xy,NULL,0,indstart,indend);
    }
    ...
    else if ( isFastKernelSum() || isFastKernelChain() || ( isFastKernelXfer() && !resmode ) || justcalcip )
    {
        ...
        if ( isFastKernelSum() || isFastKernelChain() || justcalcip )
        {
            ...
            else if ( ( ( needsDiff(0) || ( isFastKernelSum() && needsDiff() ) ) && ( ( isAltDiff() <= 199 ) || ( isAltDiff() >= 300 ) ) ) && !justcalcip )
            {
                ...
                diff3norm(diffis,xyprod,getmnorm(xainfo,xa,3,xconsist,assumreal),getmnorm(xbinfo,xb,3,xconsist,assumreal),getmnorm(xcinfo,xc,3,xconsist,assumreal),fillXYMatrix(altxy,xa,xb,xc,xainfo,xbinfo,xcinfo,xy,0,assumreal),s);
            }
        ...
        else
        {
            ...
            else if ( ( size() >= 2 ) && needsDiff(1) && ( ( isAltDiff() <= 199 ) || ( isAltDiff() >= 300 ) ) && !justcalcip )
            {
                ...
                diff3norm(diffis,xyprod,xanorm,xbnorm,xcnorm,altxy,s);
                     ...
                     const double *xy00, const double *xy10, const double *xy11, const double *xy20, const double *xy21, const double *xy22, const double *xy30, const double *xy31, const double *xy32, const double *xy33, int indstart, int indend) const
{
    ...
    if ( ( isAltDiff() == 300 ) && !justcalcip )
    {
        ...
        if ( xy )
        {
            ...
            derf("&",z) = 0; derf("&",1) = 1; LL2(tempresa,dummya,dummyb,xa,xb,xainfo,xbinfo,bias,NULL,ia,ib,xdim,xconsist,assumreal,resmode,mlid,&((*xy)(derf,derf,tmpma)),justcalcip,indstart,indend); 
            derf("&",z) = 2; derf("&",2) = 3; LL2(tempresb,dummya,dummyb,xc,xd,xcinfo,xdinfo,bias,NULL,ic,id,xdim,xconsist,assumreal,resmode,mlid,&((*xy)(derf,derf,tmpma)),justcalcip,indstart,indend); 

            tempresa *= tempresb; 
            res += tempresa;

            derf("&",z) = 0; derf("&",1) = 2; LL2(tempresa,dummya,dummyb,xa,xc,xainfo,xcinfo,bias,NULL,ia,ic,xdim,xconsist,assumreal,resmode,mlid,&((*xy)(derf,derf,tmpma)),justcalcip,indstart,indend); 
            derf("&",z) = 1; derf("&",2) = 3; LL2(tempresb,dummya,dummyb,xb,xd,xcinfo,xdinfo,bias,NULL,ib,id,xdim,xconsist,assumreal,resmode,mlid,&((*xy)(derf,derf,tmpma)),justcalcip,indstart,indend); 

            tempresa *= tempresb; 
            res += tempresa;

            derf("&",z) = 0; derf("&",1) = 3; LL2(tempresa,dummya,dummyb,xa,xd,xainfo,xdinfo,bias,NULL,ia,id,xdim,xconsist,assumreal,resmode,mlid,&((*xy)(derf,derf,tmpma)),justcalcip,indstart,indend); 
            derf("&",z) = 1; derf("&",2) = 2; LL2(tempresb,dummya,dummyb,xb,xc,xbinfo,xcinfo,bias,NULL,ib,ic,xdim,xconsist,assumreal,resmode,mlid,&((*xy)(derf,derf,tmpma)),justcalcip,indstart,indend); 
        ...
        {
            LL2(tempresa,dummya,dummyb,xa,xb,xainfo,xbinfo,bias,NULL,ia,ib,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend); LL2(tempresb,dummya,dummyb,xc,xd,xcinfo,xdinfo,bias,NULL,ic,id,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend); tempresa *= tempresb; res += tempresa;
            LL2(tempresa,dummya,dummyb,xa,xc,xainfo,xcinfo,bias,NULL,ia,ic,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend); LL2(tempresb,dummya,dummyb,xb,xd,xbinfo,xdinfo,bias,NULL,ib,id,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend); tempresa *= tempresb; res += tempresa;
            LL2(tempresa,dummya,dummyb,xa,xd,xainfo,xdinfo,bias,NULL,ia,id,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend); LL2(tempresb,dummya,dummyb,xb,xd,xbinfo,xdinfo,bias,NULL,ib,id,xdim,xconsist,assumreal,resmode,mlid,NULL,justcalcip,indstart,indend); tempresa *= tempresb; res += tempresa;
        }
    ...
    else if ( !s && ( isAltDiff() >= 100 ) && ( isAltDiff() <= 199 ) && !justcalcip )
    {
        ...
        if ( isAltDiff() == 103 )
        {
            ss("&",z) = +1; ss("&",1) = +1; ss("&",2) = +1; ss("&",3) = +1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = +1; ss("&",1) = +1; ss("&",2) = -1; ss("&",3) = -1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = +1; ss("&",1) = -1; ss("&",2) = +1; ss("&",3) = -1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = +1; ss("&",1) = -1; ss("&",2) = -1; ss("&",3) = +1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
        ...
        {
            ss("&",z) = 0; ss("&",1) = 1; ss("&",2) = 2; ss("&",3) = 3; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 0; ss("&",1) = 1; ss("&",2) = 3; ss("&",3) = 2; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 0; ss("&",1) = 2; ss("&",2) = 1; ss("&",3) = 3; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 0; ss("&",1) = 2; ss("&",2) = 3; ss("&",3) = 1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 0; ss("&",1) = 3; ss("&",2) = 1; ss("&",3) = 2; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 0; ss("&",1) = 3; ss("&",2) = 2; ss("&",3) = 1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;

            ss("&",z) = 1; ss("&",1) = 0; ss("&",2) = 2; ss("&",3) = 3; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 1; ss("&",1) = 0; ss("&",2) = 3; ss("&",3) = 2; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 1; ss("&",1) = 2; ss("&",2) = 0; ss("&",3) = 3; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 1; ss("&",1) = 2; ss("&",2) = 3; ss("&",3) = 0; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 1; ss("&",1) = 3; ss("&",2) = 0; ss("&",3) = 2; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 1; ss("&",1) = 3; ss("&",2) = 2; ss("&",3) = 0; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;

            ss("&",z) = 2; ss("&",1) = 1; ss("&",2) = 0; ss("&",3) = 3; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 2; ss("&",1) = 1; ss("&",2) = 3; ss("&",3) = 0; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 2; ss("&",1) = 0; ss("&",2) = 1; ss("&",3) = 3; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 2; ss("&",1) = 0; ss("&",2) = 3; ss("&",3) = 1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 2; ss("&",1) = 3; ss("&",2) = 1; ss("&",3) = 0; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 2; ss("&",1) = 3; ss("&",2) = 0; ss("&",3) = 1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;

            ss("&",z) = 3; ss("&",1) = 1; ss("&",2) = 2; ss("&",3) = 0; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 3; ss("&",1) = 1; ss("&",2) = 0; ss("&",3) = 2; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 3; ss("&",1) = 2; ss("&",2) = 1; ss("&",3) = 0; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 3; ss("&",1) = 2; ss("&",2) = 0; ss("&",3) = 1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 3; ss("&",1) = 0; ss("&",2) = 1; ss("&",3) = 2; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
            ss("&",z) = 3; ss("&",1) = 0; ss("&",2) = 2; ss("&",3) = 1; LL4(tempres,dummya,dummyb,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,bias,NULL,ia,ib,ic,id,xdim,xconsist,assumreal,resmode,mlid,xy,&ss,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,indstart,indend); res += tempres;
    ...
    else if ( ( resmode & 0x01 ) )
    {
        ...
        K4i(tempres,defaultgentype(),xainfo,xbinfo,xcinfo,xdinfo,getmnorm(xainfo,xa,4,xconsist,assumreal),getmnorm(xbinfo,xb,4,xconsist,assumreal),getmnorm(xcinfo,xc,4,xconsist,assumreal),getmnorm(xdinfo,xd,4,xconsist,assumreal),xa,xb,xc,xd,ia,ib,ic,id,xdim,0,resmode,mlid,fillXYMatrix(altxy,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,xy,0,assumreal),s,indstart,indend,assumreal);
    ...
    else if ( isprod && !arexysimple(xa,xb,xc,xd) )
    {
        ...
        LLm(4,res,logres,logresvalid,xx,xxinfo,bias,ii,pxyprod,xdim,xconsist,assumreal,resmode,mlid,xy,NULL,0,indstart,indend);
    }
    ...
    else if ( isFastKernelSum() || isFastKernelChain() || ( isFastKernelXfer() && !resmode ) || justcalcip )
    {
        ...
        if ( isFastKernelSum() || isFastKernelChain() || justcalcip )
        {
            ...
            else if ( ( ( needsDiff(0) || ( isFastKernelSum() && needsDiff() ) ) && ( ( isAltDiff() <= 199 ) || ( isAltDiff() >= 300 ) ) ) && !justcalcip )
            {
                ...
                if ( xy00 )
                {
                    diff4norm(diffis,xyprod,getmnorm(xainfo,xa,4,xconsist,assumreal),getmnorm(xbinfo,xb,4,xconsist,assumreal),getmnorm(xcinfo,xc,4,xconsist,assumreal),getmnorm(xdinfo,xd,4,xconsist,assumreal),*xy00,*xy10,*xy11,*xy20,*xy21,*xy22,*xy30,*xy31,*xy32,*xy33,s);
                }

                else if ( xy )
                {
                    diff4norm(diffis,xyprod,getmnorm(xainfo,xa,4,xconsist,assumreal),getmnorm(xbinfo,xb,4,xconsist,assumreal),getmnorm(xcinfo,xc,4,xconsist,assumreal),getmnorm(xdinfo,xd,4,xconsist,assumreal),*xy,s);
                }
                ...
                else
                {
                    ...
                    diff4norm(diffis,xyprod,getmnorm(xainfo,xa,4,xconsist,assumreal),getmnorm(xbinfo,xb,4,xconsist,assumreal),getmnorm(xcinfo,xc,4,xconsist,assumreal),getmnorm(xdinfo,xd,4,xconsist,assumreal),fillXYMatrix(altxy,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,xy,0,assumreal),s);
                }
            }
            ...
            else if ( ( needsDiff(0) && ( isAltDiff() >= 200 ) && ( isAltDiff() <= 299 ) ) && !justcalcip )
            {
                ...
                const Matrix<double> *sxy = &fillXYMatrix(altxy,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,xy,1,assumreal);
        ...
        else
        {
            ...
            else if ( ( size() >= 2 ) && needsDiff(1) && ( ( isAltDiff() <= 199 ) || ( isAltDiff() >= 300 ) ) && !justcalcip )
            {
                ...
                diff4norm(diffis,xyprod,xanorm,xbnorm,xcnorm,xdnorm,altxy,s);
...
void MercerKernel::xdKK2(T &xygrad, T &xnormgrad, int &minmaxind, 
                         ...
                         const Matrix<double> *xy, int deepDeriv, int iaset, int ibset) const
{
    // isfullnorm should happen here, but doesn't
    NiceAssert( !isfullnorm );

    dKK2(xygrad,xnormgrad,minmaxind,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,xy,deepDeriv,iaset,ibset);
                          ...
                          const Matrix<double> *xy, int deepDeriv, int iaset, int ibset) const
{
    ...
    d2KK2(xygrad,xnormgrad,xyxygrad,xyxnormgrad,xyynormgrad,xnormxnormgrad,xnormynormgrad,ynormynormgrad,minmaxind,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,xy,deepDeriv,iaset,ibset);
                             ...
                             const Matrix<double> *xy, int deepDeriv, int iaset, int ibset) const
{
    ...
    dnKK2del(sc,n,minmaxind,q,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,xy,deepDeriv,iaset,ibset);
...
void MercerKernel::dKK2(T &xygrad, T &xnormgrad, int &minmaxind,
                    ...
                    int ia, int ib,
                    int xdim, int xconsist, int assumreal, int mlid, 
                    const Matrix<double> *xy, int deepDeriv, 
                    int iaset, int ibset,
                    int skipbias,
                    int skipxa, int skipxb) const
{
    if ( !skipbias && isiteqn(bias) )
    {
        ...
        for ( qb = 0 ; qb < maxq ; qb++ )
        {
            ...
            dKK2(gxygrad,gxnormgrad,minmaxind,xa,xb,xainfo,xbinfo,gbias,NULL,ia,ib,xdim,xconsist,assumreal,mlid,NULL,deepDeriv,iaset,ibset,1,skipxa,skipxb);
...
postbias:
    ...
    if ( !skipxa && xainfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK2(gres,glogres,logresvalid,xxa,xb,xxainfo,xbinfo,gbias,NULL,ia,ib,xdim,xconsist,assumreal,0,mlid,NULL,0,0,size()-1,iaset,ibset);

            gentype gxygrad,gxnormgrad;

            dKK2(gxygrad,gxnormgrad,minmaxind,xxa,xb,xxainfo,xbinfo,gbias,NULL,ia,ib,xdim,xconsist,assumreal,mlid,NULL,deepDeriv,iaset,ibset,skipbias,1,skipxb);
...
postxa:
    ...
    if ( !skipxb && xbinfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            KK2(gres,glogres,logresvalid,xa,xxb,xainfo,xxbinfo,gbias,NULL,ia,ib,xdim,xconsist,assumreal,0,mlid,NULL,0,0,size()-1,iaset,ibset);

            gentype gxygrad,gxnormgrad;

            dKK2(gxygrad,gxnormgrad,minmaxind,xa,xxb,xainfo,xxbinfo,gbias,NULL,ia,ib,xdim,xconsist,assumreal,mlid,NULL,deepDeriv,iaset,ibset,skipbias,skipxa,1);
...
postxb:
    ...
    dLL2(xygrad,xnormgrad,minmaxind,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,xy,deepDeriv);
                    ...
                    int skipxa, int skipxb) const
{
    if ( !skipbias && isiteqn(bias) )
    {
        ...
        for ( qb = 0 ; qb < maxq ; qb++ )
        {
            ...
            d2KK2(tempxygrad,tempxnormgrad,tempxyxygrad,tempxyxnormgrad,tempxyynormgrad,tempxnormxnormgrad,tempxnormynormgrad,tempynormynormgrad,minmaxind,xa,xb,xainfo,xbinfo,gbias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,NULL,deepDeriv,iaset,ibset,1,skipxa,skipxb);
...
postbias:
    ...
    if ( !skipxa && xainfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            d2KK2(tempxygrad,tempxnormgrad,tempxyxygrad,tempxyxnormgrad,tempxyynormgrad,tempxnormxnormgrad,tempxnormynormgrad,tempynormynormgrad,minmaxind,xxa,xb,xxainfo,xbinfo,gbias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,NULL,deepDeriv,iaset,ibset,skipbias,1,skipxb);
...
postxa:
    ...
    if ( !skipxb && xbinfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            d2KK2(tempxygrad,tempxnormgrad,tempxyxygrad,tempxyxnormgrad,tempxyynormgrad,tempxnormxnormgrad,tempxnormynormgrad,tempynormynormgrad,minmaxind,xa,xxb,xainfo,xxbinfo,gbias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,NULL,deepDeriv,iaset,ibset,skipbias,skipxa,1);
...
postxb:
    ...
    d2LL2(xygrad,xnormgrad,xyxygrad,xyxnormgrad,xyynormgrad,xnormxnormgrad,xnormynormgrad,ynormynormgrad,minmaxind,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,xy,deepDeriv);
                           ...
                           int skipxa, int skipxb) const
{
    ...
    if ( !skipbias && isiteqn(bias) )
    {
        ...
        for ( qb = 0 ; qb < maxq ; qb++ )
        {
            ...
            dnKK2del(tempsc,nn,minmaxind,qq,xa,xb,xainfo,xbinfo,gbias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,xy,deepDeriv,iaset,ibset,1,skipxa,skipxb);
...
postbias:
    ...
    if ( !skipxa && xainfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            dnKK2del(tempsc,nn,minmaxind,qq,xxa,xb,xxainfo,xbinfo,gbias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,xy,deepDeriv,iaset,ibset,skipbias,1,skipxb);
...
postxa:
    ...
    if ( !skipxb && xbinfo.xiseqn() )
    {
        ...
        for ( qxa = 0 ; qxa < maxq ; qxa++ )
        {
            ...
            dnKK2del(tempsc,nn,minmaxind,qq,xa,xxb,xainfo,xxbinfo,gbias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,xy,deepDeriv,iaset,ibset,skipbias,skipxa,1);
...
postxb:
    ...
    dnLL2del(sc,nn,minmaxind,qq,xa,xb,xainfo,xbinfo,bias,pxyprod,ia,ib,xdim,xconsist,assumreal,mlid,xy,deepDeriv);
...
void MercerKernel::dLL2(T &xygrad, T &xnormgrad, int &minmaxind,
                    ...
                    int i, int j,
                    int xdim, int xconsist, int assumreal, int mlid, 
                    const Matrix<double> *xy, int deepDeriv) const
{
    T res;
    ...
    if ( isFastKernelSum() || isFastKernelChain() )
    {
        ...
        if ( ( needsDiff(0) || ( isFastKernelSum() && needsDiff() ) ) )
        {
            if ( xy && ( (*xy).numRows() >= 2 ) && ( (*xy).numCols() >= 2 ) )
            {
                diff2norm(diffis,(double) xyprod,(*xy)(zeroint(),zeroint()),(*xy)(1,1));
            }
