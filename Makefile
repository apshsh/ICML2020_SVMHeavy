...
#RM = rm -f
#MLMUTATEFILE = POSTSIG.TXT
#CBASEFLAGS = -DSPECIFYSYSVIAMAKE -DALLOW_SOCKETS -DENABLE_THREADS -DHAVE_TERMIOS -DHAVE_IOCTL
...
#RM = rm -f
#MLMUTATEFILE = POSTSIG.TXT
#CBASEFLAGS = -DSPECIFYSYSVIAMAKE -DALLOW_SOCKETS -DHAVE_TERMIOS -DHAVE_IOCTL
...
#RM = rm -f
#MLMUTATEFILE = POSTSIG.TXT
#CBASEFLAGS = -DSPECIFYSYSVIAMAKE -DENABLE_THREADS -DHAVE_TERMIOS -DHAVE_IOCTL
...
#RM = rm -f
#MLMUTATEFILE = POSTSIG.TXT
#CBASEFLAGS = -DSPECIFYSYSVIAMAKE -DHAVE_TERMIOS  -DHAVE_IOCTL
