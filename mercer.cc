...
extern Vector<gentype> makeanRKHSVector(Vector<gentype> &res, const MercerKernel &kern, const SparseVector<gentype> &x, const gentype &a);


Vector<gentype> &MercerKernel::phi2(Vector<gentype> &res, const SparseVector<gentype> &x, int ia, int allowfinite, int xdim, int xconsist, int iset, int assumreal) const
{
    (void) ia;
    (void) xconsist;
    (void) iset;
    ...
    else
    {
        ...
        makeanRKHSVector(res,*this,x,a);
    }

    return res;
}

Vector<double> &MercerKernel::phi2(Vector<double> &res, const SparseVector<gentype> &x, int ia, int allowfinite, int xdim, int xconsist, int iset, int assumreal) const
{
    (void) ia;
    (void) xconsist;
    (void) iset;
...
int MercerKernel::phi2dim(int allowfinite, int xdim) const
{
    const Vector<int> &ic = dIntConstants(size()-1);
                      ...
                      const Matrix<double> &xy, const Vector<int> *s, int indstart, int indend, int assumreal) const
{
    ...
    if ( indstart <= indend )
    {
        ...
        if ( needsDiff() )
        {
            ...
            diff4norm(diffis,xyprod,xanorm,xbnorm,xcnorm,xdnorm,xy,s);
        }
	...
	for ( ; q <= indend ; q++ )
	{
            if ( isChained(q) )
            {
                ...
                if ( startchain )
                {
                    ...
                    K4(Kxyres,q,xyprod,diffis,0,xainfo,xbinfo,xcinfo,xdinfo,xanorm,xbnorm,xcnorm,xdnorm,xa,xb,xc,xd,ia,ib,ic,id,xdim,densetype,resmode,mlid,xy,s);

                    K4(Kaares,q,xanorm,locdiffis,1,xainfo,xainfo,xainfo,xainfo,xanorm,xanorm,xanorm,xanorm,xa,xa,xa,xa,ia,ia,ia,ia,xdim,densetype,resmode,mlid,xy,s);
                    K4(Kbbres,q,xbnorm,locdiffis,1,xbinfo,xbinfo,xbinfo,xbinfo,xbnorm,xbnorm,xbnorm,xbnorm,xb,xb,xb,xb,ib,ib,ib,ib,xdim,densetype,resmode,mlid,xy,s);
                    K4(Kccres,q,xcnorm,locdiffis,1,xcinfo,xcinfo,xcinfo,xcinfo,xcnorm,xcnorm,xcnorm,xcnorm,xc,xc,xc,xc,ic,ic,ic,ic,xdim,densetype,resmode,mlid,xy,s);
                    K4(Kddres,q,xdnorm,locdiffis,1,xdinfo,xdinfo,xdinfo,xdinfo,xdnorm,xdnorm,xdnorm,xdnorm,xd,xd,xd,xd,id,id,id,id,xdim,densetype,resmode,mlid,xy,s);
                }
                ...
                else
                {
                    ...
                    K4(Kxyres,q,Kxyprev,locdiffis,1,Kaaprevinfo,Kbbprevinfo,Kccprevinfo,Kddprevinfo,Kaaprev,Kbbprev,Kccprev,Kddprev,xa,xb,xc,xd,ia,ib,ic,id,xdim,densetype,resmode,mlid,xy,s);
                    K4(Kaares,q,Kaaprev,locdiffis,1,Kaaprevinfo,Kaaprevinfo,Kaaprevinfo,Kaaprevinfo,Kaaprev,Kaaprev,Kaaprev,Kaaprev,xa,xa,xa,xa,ia,ia,ia,ia,xdim,densetype,resmode,mlid,xy,s);
                    K4(Kbbres,q,Kbbprev,locdiffis,1,Kbbprevinfo,Kbbprevinfo,Kbbprevinfo,Kbbprevinfo,Kbbprev,Kbbprev,Kbbprev,Kbbprev,xb,xb,xb,xb,ib,ib,ib,ib,xdim,densetype,resmode,mlid,xy,s);
                    K4(Kccres,q,Kccprev,locdiffis,1,Kccprevinfo,Kccprevinfo,Kccprevinfo,Kccprevinfo,Kccprev,Kccprev,Kccprev,Kccprev,xc,xc,xc,xc,ic,ic,ic,ic,xdim,densetype,resmode,mlid,xy,s);
                    K4(Kddres,q,Kddprev,locdiffis,1,Kddprevinfo,Kddprevinfo,Kddprevinfo,Kddprevinfo,Kddprev,Kddprev,Kddprev,Kddprev,xd,xd,xd,xd,id,id,id,id,xdim,densetype,resmode,mlid,xy,s);
                }
                      ...
                      const Matrix<double> &xy, const Vector<int> *s) const
{
    ...
    K4unnorm(res,q,xyprod,diffis,recalcdiffis,xainfo,xbinfo,xcinfo,xdinfo,xanorm,xbnorm,xcnorm,xdnorm,xa,xb,xc,xd,ia,ib,ic,id,xdim,densetype,resmode,mlid,xy,s);
    ...
    if ( isNormalised(q) )
    {
        ...
        K4unnorm(xakern,q,xanorm,locdiffis,1,xainfo,xainfo,xainfo,xainfo,xanorm,xanorm,xanorm,xanorm,xa,xa,xa,xa,ia,ia,ia,ia,xdim,densetype,resmode,mlid,xy(z*oneintvec(( 4 <= xy.numRows() ) ? 4 : xy.numRows(),tmpva),z*oneintvec(( 4 <= xy.numCols() ) ? 4 : xy.numCols(),tmpva),tmpma),s);
        K4unnorm(xbkern,q,xbnorm,locdiffis,1,xbinfo,xbinfo,xbinfo,xbinfo,xbnorm,xbnorm,xbnorm,xbnorm,xb,xb,xb,xb,ib,ib,ib,ib,xdim,densetype,resmode,mlid,xy(1*oneintvec(( 4 <= xy.numRows() ) ? 4 : xy.numRows(),tmpva),1*oneintvec(( 4 <= xy.numCols() ) ? 4 : xy.numCols(),tmpva),tmpma),s);
        K4unnorm(xckern,q,xcnorm,locdiffis,1,xcinfo,xcinfo,xcinfo,xcinfo,xcnorm,xcnorm,xcnorm,xcnorm,xc,xc,xc,xc,ic,ic,ic,ic,xdim,densetype,resmode,mlid,xy(2*oneintvec(( 4 <= xy.numRows() ) ? 4 : xy.numRows(),tmpva),2*oneintvec(( 4 <= xy.numCols() ) ? 4 : xy.numCols(),tmpva),tmpma),s);
        K4unnorm(xdkern,q,xdnorm,locdiffis,1,xdinfo,xdinfo,xdinfo,xdinfo,xdnorm,xdnorm,xdnorm,xdnorm,xd,xd,xd,xd,id,id,id,id,xdim,densetype,resmode,mlid,xy(3*oneintvec(( 4 <= xy.numRows() ) ? 4 : xy.numRows(),tmpva),3*oneintvec(( 4 <= xy.numCols() ) ? 4 : xy.numCols(),tmpva),tmpma),s);
...
const Matrix<double> &MercerKernel::fillXYMatrix(Matrix<double> &altres, const SparseVector<gentype> &xa, const vecInfo &xainfo, const Matrix<double> *optionCache, int doanyhow, int assumreal) const
{
    NiceAssert( !optionCache || ( ( (*optionCache).numRows() == 1 ) && ( (*optionCache).numCols() == 1 ) ) );
    ...
    if ( !optionCache && ( needsMatDiff() || doanyhow ) )
    {
        ...
        altres("&",z,z) = (double) getmnorm(xainfo,xa,2,0,assumreal);
    }

    return optionCache ? *optionCache : altres;
}

const Matrix<double> &MercerKernel::fillXYMatrix(Matrix<double> &altres, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const vecInfo &xainfo, const vecInfo &xbinfo, const Matrix<double> *optionCache, int doanyhow, int assumreal) const
{
    (void) altres;
    (void) xa;
    (void) xb;
    ...
    // 2*2 cache never used, so no need to do anything

    return optionCache ? *optionCache : altres;
}

const Matrix<double> &MercerKernel::fillXYMatrix(Matrix<double> &altres, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const Matrix<double> *optionCache, int doanyhow, int assumreal) const
{
    NiceAssert( !optionCache || ( ( (*optionCache).numRows() == 3 ) && ( (*optionCache).numCols() == 3 ) ) );
    ...
    if ( !optionCache && ( needsMatDiff() || doanyhow ) )
    {
        ...
        twoProductDiverted(altres("&",z,1),xa,xb);
        twoProductDiverted(altres("&",z,2),xa,xc);
        twoProductDiverted(altres("&",1,2),xb,xc);

        altres("&",1,z) = altres(z,1);
        altres("&",2,z) = altres(z,2);
        altres("&",2,1) = altres(1,2);

        altres("&",z,z) = (double) getmnorm(xainfo,xa,2,0,assumreal);
        altres("&",1,1) = (double) getmnorm(xbinfo,xb,2,0,assumreal);
        altres("&",2,2) = (double) getmnorm(xcinfo,xc,2,0,assumreal);
    }

    return optionCache ? *optionCache : altres;
}

const Matrix<double> &MercerKernel::fillXYMatrix(Matrix<double> &altres, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const SparseVector<gentype> &xd, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const vecInfo &xdinfo, const Matrix<double> *optionCache, int doanyhow, int assumreal) const
{
    NiceAssert( !optionCache || ( ( (*optionCache).numRows() == 4 ) && ( (*optionCache).numCols() == 4 ) ) );
    ...
    if ( !optionCache && ( needsMatDiff() || doanyhow ) )
    {
        ...
        twoProductDiverted(altres("&",z,1),xa,xb);
        twoProductDiverted(altres("&",z,2),xa,xc);
        twoProductDiverted(altres("&",z,3),xa,xd);
        twoProductDiverted(altres("&",1,2),xb,xc);
        twoProductDiverted(altres("&",1,3),xb,xd);
        twoProductDiverted(altres("&",2,3),xc,xd);

        altres("&",1,z) = altres(z,1);
        altres("&",2,z) = altres(z,2);
        altres("&",2,1) = altres(1,2);
        altres("&",3,z) = altres(z,3);
        altres("&",3,1) = altres(1,3);
        altres("&",3,2) = altres(2,3);

        altres("&",z,z) = (double) getmnorm(xainfo,xa,2,0,assumreal);
        altres("&",1,1) = (double) getmnorm(xbinfo,xb,2,0,assumreal);
        altres("&",2,2) = (double) getmnorm(xcinfo,xc,2,0,assumreal);
        altres("&",3,3) = (double) getmnorm(xdinfo,xd,2,0,assumreal);
    }
...
void MercerKernel::diff3norm(gentype &res, const gentype &xyprod, const gentype &xanorm, const gentype &xbnorm, const gentype &xcnorm, const Matrix<double> &xxyy, const Vector<int> *s) const
{
    (void) xxyy;
    (void) s;
    ...
    else if ( isAltDiff() == 2 )
    {
        ...
        res -= ( xxyy(z,z) + xxyy(z,1) + xxyy(z,2))/3.0;
        res -= ( xxyy(1,z) + xxyy(1,1) + xxyy(1,2))/3.0;
        res -= ( xxyy(2,z) + xxyy(2,1) + xxyy(2,2))/3.0;
...
void MercerKernel::diff4norm(gentype &res, const gentype &xyprod, const gentype &xanorm, const gentype &xbnorm, const gentype &xcnorm, const gentype &xdnorm, const Matrix<double> &xxyy, const Vector<int> *s) const
{
    // xanorm, ... are ||xa||_m^m if isAltDiff == 0, ||xa||_2^2 otherwise
    ...
    else if ( isAltDiff() == 2 )
    {
        ...
        res -= ( xxyy(z,z) + xxyy(z,1) + xxyy(z,2) + xxyy(z,3))/4.0;
        res -= ( xxyy(1,z) + xxyy(1,1) + xxyy(1,2) + xxyy(1,3))/4.0;
        res -= ( xxyy(2,z) + xxyy(2,1) + xxyy(2,2) + xxyy(2,3))/4.0;
        res -= ( xxyy(3,z) + xxyy(3,1) + xxyy(3,2) + xxyy(3,3))/4.0;
    ...
    else if ( isAltDiff() == 103 )
    {
        ...
        res  = ((*s)(z)*(*s)(z)*xxyy(z,z)) + ((*s)(z)*(*s)(1)*xxyy(z,1)) + ((*s)(z)*(*s)(2)*xxyy(z,2)) + ((*s)(z)*(*s)(3)*xxyy(z,3));
        res += ((*s)(1)*(*s)(z)*xxyy(1,z)) + ((*s)(1)*(*s)(1)*xxyy(1,1)) + ((*s)(1)*(*s)(2)*xxyy(1,2)) + ((*s)(1)*(*s)(3)*xxyy(1,3));
        res += ((*s)(2)*(*s)(z)*xxyy(2,z)) + ((*s)(2)*(*s)(1)*xxyy(2,1)) + ((*s)(2)*(*s)(2)*xxyy(2,2)) + ((*s)(2)*(*s)(3)*xxyy(2,3));
        res += ((*s)(3)*(*s)(z)*xxyy(3,z)) + ((*s)(3)*(*s)(1)*xxyy(3,1)) + ((*s)(3)*(*s)(2)*xxyy(3,2)) + ((*s)(3)*(*s)(3)*xxyy(3,3));
    }
...
void MercerKernel::diff3norm(double &res, const double &xyprod, const double &xanorm, const double &xbnorm, const double &xcnorm, const Matrix<double> &xxyy, const Vector<int> *s) const
{
    (void) xxyy;
    (void) s;
...
void MercerKernel::diff4norm(double &res, const double &xyprod, const double &xanorm, const double &xbnorm, const double &xcnorm, const double &xdnorm, const Matrix<double> &xxyy, const Vector<int> *s) const
{
    // xanorm, ... are ||xa||_m^m if isAltDiff == 0, ||xa||_2^2 otherwise
...
int MercerKernel::getparam(int ind, gentype &val, const gentype &xa, int ia, const gentype &xb, int ib) const
{
    ...
    else if ( xa.isCastableToIntegerWithoutLoss() && ( (int) xa < size() ) )
    {
        ...
        switch ( ind )
        {
            ...
            case  53: { val = isUnNormalised((int) xa);        break; }
            case  54: { val = isChained((int) xa);             break; }
            case  55: { val = isUnChained((int) xa);           break; }
            ...
            case  63: { val = isUnSplit((int) xa);             break; }
            case  64: { val = isMagTerm((int) xa);             break; }
            case  65: { val = isUnMagTerm((int) xa);           break; }
            case  66: { val = isMulSplit((int) xa);            break; }
            case  67: { val = isUnMulSplit((int) xa);          break; }
