...
public:
    ...
    Vector<T> &operator()(const char *dummy,                         retVector<T> &tmp) { (void) dummy; (void) tmp; if ( imoverhere ) { return *imoverhere; } return *this; }
    ...
    const Vector<T> &operator()(                        retVector<T> &tmp) const { (void) tmp; if ( imoverhere ) { return *imoverhere; } return *this; }
    ...
    virtual T &operator()(T &res, const        T  &i) const { if ( imoverhere ) { return (*imoverhere)(res,i); } throw("Continuous dereference not allowed for finite dimensional vector."); return res; }
    virtual T &operator()(T &res, const Vector<T> &i) const { if ( imoverhere ) { return (*imoverhere)(res,i); } throw("Continuous dereference not allowed for finite dimensional vector."); return res; }
    ...
    virtual int type(void)    const { return imoverhere ? (*imoverhere).type()    : 0; }
            int size(void)    const { return dsize;                                    }
            int order(void)   const { return ceilintlog2(size());                      }
    virtual int infsize(void) const { return imoverhere ? (*imoverhere).infsize() : 0; }
    ...
    virtual int array_norm (void) const { return imoverhere ? (*imoverhere).array_norm()  : ( content ? (*content).array_norm()  : 1 ); }
    virtual int array_tight(void) const { return imoverhere ? (*imoverhere).array_tight() : ( content ? (*content).array_tight() : 0 ); }
    virtual int array_slack(void) const { return imoverhere ? (*imoverhere).array_slack() : ( content ? (*content).array_slack() : 0 ); }
    ...
    virtual T &inner1(T &res                                                            ) const {                                           if ( imoverhere ) { (*imoverhere).inner1(res);       } else { throw("Not an FuncVector 1"); } return res; }
    virtual T &inner2(T &res, const Vector<T> &b, int conj = 1                          ) const { (void) b; (void) conj;                    if ( imoverhere ) { (*imoverhere).inner2(res,b);     } else if ( b.imoverhere ) { b.inner2(res,*this,( conj == 1 ) ? 2 : ( ( conj == 2 ) ? 1 : 0 )); } else { throw("Not an FuncVector 2"); } return res; }
    virtual T &inner3(T &res, const Vector<T> &b, const Vector<T> &c                    ) const { (void) b; (void) c; (void) res;           if ( imoverhere ) { (*imoverhere).inner3(res,b,c);   } else if ( b.imoverhere ) { b.inner3(res,*this,c); } else if ( c.imoverhere ) { b.inner3(res,b,*this); } else { throw("Not an FuncVector 3"); } return res; }
    virtual T &inner4(T &res, const Vector<T> &b, const Vector<T> &c, const Vector<T> &d) const { (void) b; (void) c; (void) d; (void) res; if ( imoverhere ) { (*imoverhere).inner4(res,b,c,d); } else if ( b.imoverhere ) { b.inner4(res,*this,c,d); } else if ( c.imoverhere ) { c.inner4(res,b,*this,d); } else if ( d.imoverhere ) { d.inner4(res,b,c,*this); } else { throw("Not an FuncVector 4"); } return res; }
    virtual T &innerp(T &res, const Vector<const Vector<T> *> &b                        ) const { (void) b; (void) res;                     if ( imoverhere ) { (*imoverhere).innerp(res,b);     } else { throw("Not an FuncVector 5"); } return res; }

    virtual double &inner1Real(double &res                                                            ) const {                                           if ( imoverhere ) { (*imoverhere).inner1Real(res);       } else { throw("Not an FuncVector 6"); } return res; }
    virtual double &inner2Real(double &res, const Vector<T> &b, int conj = 1                          ) const { (void) b; (void) conj;                    if ( imoverhere ) { (*imoverhere).inner2Real(res,b);     } else { throw("Not an FuncVector 7"); } return res; }
    virtual double &inner3Real(double &res, const Vector<T> &b, const Vector<T> &c                    ) const { (void) b; (void) c; (void) res;           if ( imoverhere ) { (*imoverhere).inner3Real(res,b,c);   } else { throw("Not an FuncVector 8"); } return res; }
    virtual double &inner4Real(double &res, const Vector<T> &b, const Vector<T> &c, const Vector<T> &d) const { (void) b; (void) c; (void) d; (void) res; if ( imoverhere ) { (*imoverhere).inner4Real(res,b,c,d); } else { throw("Not an FuncVector 9"); } return res; }
    virtual double &innerpReal(double &res, const Vector<const Vector<T> *> &b                        ) const { (void) b; (void) res;                     if ( imoverhere ) { (*imoverhere).innerpReal(res,b);     } else { throw("Not an FuncVector 10"); } return res; }

    virtual double norm1(void)     const { double res = 0.0;           if ( imoverhere ) { res = (*imoverhere).norm1();  } else { throw("Not an FuncVector 11"); } return res; }
    virtual double norm2(void)     const { double res = 0.0;           if ( imoverhere ) { res = (*imoverhere).norm2();  } else { throw("Not an FuncVector 12"); } return res; }
    virtual double normp(double p) const { double res = 0.0; (void) p; if ( imoverhere ) { res = (*imoverhere).normp(p); } else { throw("Not an FuncVector 13"); } return res; }
    ...
    virtual double absinf(void)   const { double res = 0.0; if ( imoverhere ) { res = (*imoverhere).absinf(); } else { throw("Not an FuncVector 14"); } return res; }
    virtual double absd(void)     const { return abs2(); }

    virtual Vector<T> &subit (const Vector<T> &b) { if ( imoverhere ) { (*imoverhere).subit(b);  } else { throw("Not in FuncVector 15"); } return *this; }
    virtual Vector<T> &addit (const Vector<T> &b) { if ( imoverhere ) { (*imoverhere).addit(b);  } else { throw("Not in FuncVector 16"); } return *this; }
    virtual Vector<T> &mulit (const T         &b) { if ( imoverhere ) { (*imoverhere).mulit(b);  } else { throw("Not in FuncVector 17"); } return *this; } // this*b
    virtual Vector<T> &rmulit(const T         &b) { if ( imoverhere ) { (*imoverhere).rmulit(b); } else { throw("Not in FuncVector 18"); } return *this; } // b*this
    virtual Vector<T> &divit (const T         &b) { if ( imoverhere ) { (*imoverhere).divit(b);  } else { throw("Not in FuncVector 19"); } return *this; } // this/b
    virtual Vector<T> &rdivit(const T         &b) { if ( imoverhere ) { (*imoverhere).rdivit(b); } else { throw("Not in FuncVector 20"); } return *this; } // b\this

    virtual int iseq(const Vector<T> &b) { if ( imoverhere ) { return (*imoverhere).iseq(b); } else { throw("Not in FuncVector 21"); } return 0; }
...
Vector<T>::Vector(const Vector<T> &src)
{
    *thisindirect = this;
    ...
    if ( src.imoverhere )
    {
        imoverhere = (*(src.imoverhere)).makeDup();
    }
...
Vector<T> &Vector<T>::assign(const Vector<T> &src)
{
    ...
    {
        if ( (*imoverhere).type() == (*(src.imoverhere)).type() )
        {
            (*imoverhere).assign(*(src.imoverhere));
        }
    ...
    {
        if ( (*imoverhere).type() == src.type() )
        {
            (*imoverhere).assign(src);
        }
...
void Vector<T>::prealloc(int newallocsize)
{
    if ( imoverhere )
    {
        (*imoverhere).prealloc(newallocsize);
    }
...
void Vector<T>::useStandardAllocation(void)
{
    if ( imoverhere )
    {
        (*imoverhere).useStandardAllocation();
    }
...
std::ostream &operator<<(std::ostream &output, const Vector<T> &src)
{
    if ( src.imoverhere )
    {
        (*(src.imoverhere)).outstream(output);
    }
...
std::istream &operator>>(std::istream &input, Vector<T> &dest)
{
    ...
    if ( ( tt == '[' ) && ( input.peek() == '[' ) )
    {
        ...
        if ( dest.imoverhere )
        {
            ...
            {
                (*(dest.imoverhere)).instream(input);
            }
...
std::istream &streamItIn(std::istream &input, Vector<T> &dest, int processxyzvw)
{
    ...
    if ( ( tt == '[' ) && ( input.peek() == '[' ) )
    {
        ...
        if ( dest.imoverhere )
        {
            ...
            if ( (*(dest.imoverhere)).testsametype(typestring) )
            {
                (*(dest.imoverhere)).streamItIn(input,processxyzvw);
            }
