...
gentype &UUcallbackdef(gentype &res, int m, const ML_Base &caller, Vector<int> &iokr, Vector<int> &iok, Vector<int> &iset, Vector<const gentype *> xalt, int defbasis);
...
const gentype &VVcallbackdef(gentype &res, int m, const gentype &kval, const ML_Base &caller, Vector<int> &iokr, Vector<int> &iok, Vector<int> &iset, Vector<const gentype *> xalt, int defbasis);
...
public:
    ...
    virtual int fspaceDim(void)    const { return getKernel().phi2dim(1,xspaceDim()); }
    ...
    virtual Vector<gentype> &phi2(Vector<gentype> &res, int ia, const SparseVector<gentype> *xa = NULL, const vecInfo *xainf = NULL, int iaset = 0) const;
    ...
    virtual Vector<double> &phi2(Vector<double> &res, int ia, const SparseVector<gentype> *xa = NULL, const vecInfo *xainf = NULL, int iaset = 0) const;

    virtual double &K0ip(       double &res, const gentype **pxyprod = NULL) const { return KK0ip(res,0.0,pxyprod); }
    virtual double &K2ip(       double &res, int i, int j, const gentype **pxyprod = NULL, const SparseVector<gentype> *xx = NULL, const SparseVector<gentype> *yy = NULL, const vecInfo *xxinfo = NULL, const vecInfo *yyinfo = NULL) const { int iaset = 0; int ibset = 0; return KK2ip(res,i,j,0.0,pxyprod,xx,yy,xxinfo,yyinfo,iaset,ibset); }
    virtual double &K4ip(       double &res, int ia, int ib, int ic, int id, const gentype **pxyprod = NULL, const SparseVector<gentype> *xa = NULL, const SparseVector<gentype> *xb = NULL, const SparseVector<gentype> *xc = NULL, const SparseVector<gentype> *xd = NULL, const vecInfo *xainfo = NULL, const vecInfo *xbinfo = NULL, const vecInfo *xcinfo = NULL, const vecInfo *xdinfo = NULL) const { int iaset = 0; int ibset = 0; int icset = 0; int idset = 0; return KK4ip(res,ia,ib,ic,id,0.0,pxyprod,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,iaset,ibset,icset,idset); }
    virtual double &Kmip(int m, double &res, Vector<int> &i, const gentype **pxyprod = NULL, Vector<const SparseVector<gentype> *> *xx = NULL, Vector<const vecInfo *> *xxinfo = NULL) const { Vector<int> iset(m); iset = zeroint(); return KKmip(m,res,i,0.0,pxyprod,xx,xxinfo,iset); }

    virtual double &K0ip(       double &res, const double &bias, const gentype **pxyprod = NULL) const { return KK0ip(res,bias,pxyprod); }
    virtual double &K2ip(       double &res, int i, int j, const double &bias, const gentype **pxyprod = NULL, const SparseVector<gentype> *xx = NULL, const SparseVector<gentype> *yy = NULL, const vecInfo *xxinfo = NULL, const vecInfo *yyinfo = NULL) const { int iaset = 0; int ibset = 0; return KK2ip(res,i,j,bias,pxyprod,xx,yy,xxinfo,yyinfo,iaset,ibset); }
    virtual double &K4ip(       double &res, int ia, int ib, int ic, int id, const double &bias, const gentype **pxyprod = NULL, const SparseVector<gentype> *xa = NULL, const SparseVector<gentype> *xb = NULL, const SparseVector<gentype> *xc = NULL, const SparseVector<gentype> *xd = NULL, const vecInfo *xainfo = NULL, const vecInfo *xbinfo = NULL, const vecInfo *xcinfo = NULL, const vecInfo *xdinfo = NULL) const { int iaset = 0; int ibset = 0; int icset = 0; int idset = 0; return KK4ip(res,ia,ib,ic,id,bias,pxyprod,xa,xb,xc,xd,xainfo,xbinfo,xcinfo,xdinfo,iaset,ibset,icset,idset); }
    virtual double &Kmip(int m, double &res, Vector<int> &i, const double &bias, const gentype **pxyprod = NULL, Vector<const SparseVector<gentype> *> *xx = NULL, Vector<const vecInfo *> *xxinfo = NULL) const { Vector<int> iset(m); iset = zeroint(); return KKmip(m,res,i,bias,pxyprod,xx,xxinfo,iset); }
    ...
    virtual int ggTrainingVector(double         &resg, int i, int retaltg = 0, gentype ***pxyprodi = NULL) const { gentype res; int resi = ggTrainingVector(res,i,retaltg); resg = (double) res;           return resi; }
    virtual int ggTrainingVector(Vector<double> &resg, int i, int retaltg = 0, gentype ***pxyprodi = NULL) const;
    virtual int ggTrainingVector(d_anion        &resg, int i, int retaltg = 0, gentype ***pxyprodi = NULL) const { gentype res; int resi = ggTrainingVector(res,i,retaltg); resg = (const d_anion &) res;  return resi; }
    ...
    virtual int detangle_x(int i, int usextang = 0) const
    {
        ...
        if ( !usextang )
        {
            ...
            res = detangle_x(xnear,xfar,xfarfar,xnearinfo,xfarinfo,inear,ifar,ineartup,ifartup,iokr,iok,i,idiagr,xx,xxinfo,igradOrder,iplanr,iplan,iset,usextang);
        }
    ...
    virtual int detangle_x(const SparseVector<gentype> *&xnear, const SparseVector<gentype> *&xfar, const SparseVector<gentype> *&xfarfar, 
                   ...
                   int &iplanr, int &iplan, int &iset, int usextang = 1) const
    {
...
//            int ind5present = xib.isfarfarfarindpresent(5) && !(xib(5).isValNull());
            ...
            int ilr     = ind0present ? 1 : 0;
            int irr     = ind1present ? 1 : 0;
            int igr     = ind2present ? 1 : 0;
...
private:
    ...
    template <class T> T &K1(T &res, int ia, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, const SparseVector<gentype> *xa, const vecInfo *xainfo, int resmode, int &iaset) const;
    template <class T> T &K2(T &res, int ia, int ib, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, const SparseVector<gentype> *xa, const SparseVector<gentype> *xb, const vecInfo *xainfo, const vecInfo *xbinfo, int resmode, int &iaset, int &ibset) const;
    template <class T> T &K3(T &res, int ia, int ib, int ic, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, const SparseVector<gentype> *xa, const SparseVector<gentype> *xb, const SparseVector<gentype> *xc, const vecInfo *xainfo, const vecInfo *xbinfo, const vecInfo *xcinfo, int resmode, int &iaset, int &ibset, int &icset) const;
    template <class T> T &K4(T &res, int ia, int ib, int ic, int id, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, const SparseVector<gentype> *xa, const SparseVector<gentype> *xb, const SparseVector<gentype> *xc, const SparseVector<gentype> *xd, const vecInfo *xainfo, const vecInfo *xbinfo, const vecInfo *xcinfo, const vecInfo *xdinfo, int resmode, int &iaset, int &ibset, int &icset, int &idset) const;
    template <class T> T &Km(int m, T &res, Vector<int> &ii, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, Vector<const SparseVector<gentype> *> *xx, Vector<const vecInfo *> *xxinfo, int resmode, const SparseVector<gentype> *agrad, const SparseVector<gentype> *bgrad, int agradind, int bgradind, int agradorder, int bgradorder, Vector<int> &iset) const;

    virtual double &KK0ip(       double &res, const double &bias, const gentype **pxyprod) const;
    virtual double &KK2ip(       double &res, int ia, int ib, const double &bias, const gentype **pxyprod, const SparseVector<gentype> *xa, const SparseVector<gentype> *xb, const vecInfo *xainfo, const vecInfo *xbinfo, int &iaset, int &ibset) const;
    virtual double &KK4ip(       double &res, int ia, int ib, int ic, int id, const double &bias, const gentype **pxyprod, const SparseVector<gentype> *xa, const SparseVector<gentype> *xb, const SparseVector<gentype> *xc, const SparseVector<gentype> *xd, const vecInfo *xainfo, const vecInfo *xbinfo, const vecInfo *xcinfo, const vecInfo *xdinfo, int &iaset, int &ibset, int &icset, int &idset) const;
    virtual double &KKmip(int m, double &res, Vector<int> &i, const double &bias, const gentype **pxyprod, Vector<const SparseVector<gentype> *> *xx, Vector<const vecInfo *> *xxinfo, Vector<int> &iset) const;

    template <class T>
    void dK(T &xygrad, T &xnormgrad, int i, int j, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, const SparseVector<gentype> *xx, const SparseVector<gentype> *yy, const vecInfo *xxinfo, const vecInfo *yyinfo, int deepDeriv, int &iaset, int &ibset) const;
    template <class T>
    void dK2delx(T &xscaleres, T &yscaleres, int &minmaxind, int i, int j, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, const SparseVector<gentype> *xx, const SparseVector<gentype> *yy, const vecInfo *xxinfo, const vecInfo *yyinfo, int &iaset, int &ibset) const;

    template <class T>
    void d2K(T &xygrad, T &xnormgrad, T &xyxygrad, T &xyxnormgrad, T &xyynormgrad, T &xnormxnormgrad, T &xnormynormgrad, T &ynormynormgrad, int &minmaxind, int i, int j, const T &bias, const MercerKernel &altK, const gentype **pxyprod, const SparseVector<gentype> *xx, const SparseVector<gentype> *yy, const vecInfo *xxinfo, const vecInfo *yyinfo, int &iset, int &jset) const;
    template <class T>
    void d2K2delxdelx(T &xxscaleres, T &yyscaleres, T &xyscaleres, T & yxscaleres, T &constres, int &minmaxind, int i, int j, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, const SparseVector<gentype> *xx, const SparseVector<gentype> *yy, const vecInfo *xxinfo, const vecInfo *yyinfo, int &iset, int &jset) const;
    template <class T>
    void d2K2delxdely(T &xxscaleres, T &yyscaleres, T &xyscaleres, T & yxscaleres, T &constres, int &minmaxind, int i, int j, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, const SparseVector<gentype> *xx, const SparseVector<gentype> *yy, const vecInfo *xxinfo, const vecInfo *yyinfo, int &iset, int &jset) const;

    template <class T>
    void dnK2del(Vector<T> &sc, Vector<Vector<int> > &n, int &minmaxind, const Vector<int> &q, int i, int j, const T &bias, const MercerKernel &Kx, const gentype **pxyprod, const SparseVector<gentype> *xx, const SparseVector<gentype> *yy, const vecInfo *xxinfo, const vecInfo *yyinfo, int &iset, int &jset) const;
...
//FIXME    Vector<const vecInfo *> traininfop;
    ...
    gentype &(*UUcallback)(gentype &res, int m, const ML_Base &caller, Vector<int> &iokr, Vector<int> &iok, Vector<int> &iset, Vector<const gentype *> xalt, int defbasis);
    const gentype &(*VVcallback)(gentype &res, int m, const gentype &kval, const ML_Base &caller, Vector<int> &iokr, Vector<int> &iok, Vector<int> &iset, Vector<const gentype *> xalt, int defbasis);
...
//FIXME    qswap(traininfop     ,b.traininfop     );
    ...
    gentype &(*UUcallbackxx)(gentype &res, int m, const ML_Base &caller, Vector<int> &iokr, Vector<int> &iok, Vector<int> &iset, Vector<const gentype *> xalt, int defbasis);
    const gentype &(*VVcallbackxx)(gentype &res, int m, const gentype &kval, const ML_Base &caller, Vector<int> &iokr, Vector<int> &iok, Vector<int> &iset, Vector<const gentype *> xalt, int defbasis);
