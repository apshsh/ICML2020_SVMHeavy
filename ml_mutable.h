...
public:
    ...
    virtual Vector<gentype> &phi2(Vector<gentype> &res, int ia, const SparseVector<gentype> *xa = NULL, const vecInfo *xainf = NULL, int iaset = 0) const { return getMLconst().phi2(res,ia,xa,xainf,iaset); }
    ...
    virtual Vector<double> &phi2(Vector<double> &res, int ia, const SparseVector<gentype> *xa = NULL, const vecInfo *xainf = NULL, int iaset = 0) const { return getMLconst().phi2(res,ia,xa,xainf,iaset); }
    ...
    {
        return getMLconst().detangle_x(xnear,xfar,xfarfar,xnearinfo,xfarinfo,inear,ifar,ineartup,ifartup,iokr,iok,i,idiagr,xx,xxinfo,gradOrder,iplanr,iplan,iset,usextang);
    }
