...
inline int svm_recvfrom(int a, char *b, int c, int d, svm_sockaddr *e, int *f);
inline int svm_recvfrom(int a, char *b, int c, int d, svm_sockaddr *e, int *f) { return recvfrom(a,b,c,d,e,f); }
...
inline int svm_accept(int a, svm_sockaddr *b, int *c);
inline int svm_accept(int a, svm_sockaddr *b, int *c) { return accept(a,b,c); }
...
inline int svm_recvfrom(int a, char *b, int c, int d, svm_sockaddr *e, int *f);
inline int svm_recvfrom(int a, char *b, int c, int d, svm_sockaddr *e, int *f) { (void) a; (void) b; (void) c; (void) d; (void) e; (void) f; return -1; }
...
inline int svm_accept(int a, svm_sockaddr *b, int *c);
inline int svm_accept(int a, svm_sockaddr *b, int *c) { (void) a; (void) b; (void) c; return -1; }
...
inline void svm_srand(unsigned int sval);
...
inline void svm_usleep(int stm);
